...
public final class DefaultWidgetSupplier implements WidgetSupplier {
   ...
   public ElementHandler g(KalamaHelperHelperO builder) {
      RawTextElement var2 = new RawTextElement(this.safeTextProvider(builder.q), builder.r == null ? ColorSampler.WHITE : builder.r, builder.alignment);
   ...
   private ElementHandler i(KalamaHelperHelperD<?> builder) {
      ...
      IconElement$SimpleIconElement var4 = new IconElement$SimpleIconElement(var3, var2, builder.l, this.n(builder.i));
