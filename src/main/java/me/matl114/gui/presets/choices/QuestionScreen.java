...
public class QuestionScreen extends GenericBackGroundScreen {
   ...
   protected void init() {
      ...
      DisplayWidget.instance(this.x + 5, this.y + 30, var1, var3).<DrawableWidget>setRenderHandler(LabelElement.instance(Text.empty())).addTo(this);
      DisplayWidget.instance(this.x + 5, this.y + 30, var1, var3).<DrawableWidget>setRenderHandler(new MultiLineTextElement(this.eG, -1)).addTo(this);
      ...
      for (int var8 = 0; var8 < var5; var8++) {
         for (int var9 = 0; var9 < 3; var9++) {
            ...
            ExecutableWidget.instance(this.x + 5 + 80 * var9, var7 + 30 * var8, 70, 20)
               .<ExecutableWidget>eV(new ButtonElement(TextProvider.c(var10.getSolutionLabel()), ButtonAction.a(this.fY(var10::execution))))
               .addTo(this);
         }
      }
      ...
      if (var6 != 0) {
         ...
         for (int var12 = 0; var12 < var6; var12++) {
            ...
            ExecutableWidget.instance(this.x + var11 + 80 * var12, var7 + 30 * var5, 70, 20)
               .<ExecutableWidget>eV(new ButtonElement(TextProvider.c(var13.getSolutionLabel()), ButtonAction.a(this.fY(var13::execution))))
               .addTo(this);
         }
      }
   }
