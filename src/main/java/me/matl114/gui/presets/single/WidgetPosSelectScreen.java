...
public class WidgetPosSelectScreen extends GenericScreen {
    ...
    public WidgetPosSelectScreen(
            int backgroundWidth, KalamaHelperHelperM initializePoint, Consumer<KalamaHelperHelperM> pointAcceptor) {
        super(
    ...
    protected void init() {
        ...
        ExecutableWidget.instance(0, 0, this.width, this.height)
                .<ExecutableWidget>eT(KalamaHelperHelperP.ay((element, mouseX, mouseY, button, type) -> {
                    if (button == 0) {
