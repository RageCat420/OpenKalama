...
public class RegistryDisplays {
    ...
    public static Map<Class<?>, RegistryDisplays$IIcon<?>> d =
            ImmutableMap.<Class<?>, RegistryDisplays$IIcon<?>>builder()
                    ...
                    .put(
                            Potion.class,
                            RegistryDisplays$IIcon.<Potion>c(v ->
                                    PotionContentsComponent.createStack(Items.POTION, Registries.POTION.getEntry(v))))
    ...
    private static <T> Text guessTranslation(T val) {
        if (val instanceof StatusEffect var1) {
            ...
            return val instanceof Potion var9
                    ? Text.translatable(Items.POTION.getTranslationKey() + ".effect." + var9.baseName)
                    : null;
        }
    }
    ...
    public static <T> Text b(Registry<T> registry, @Nonnull T val) {
        ...
        if (var2 != null) {
            ...
            return var3 != null
                    ? Text.translatable(registry.getKey().getValue().getPath() + ".minecraft." + var3.getPath())
    ...
    public static <T> RegistryDisplays$IIcon<T> g(Registry<T> registryClass) {
        return (RegistryDisplays$IIcon<T>)
                d.getOrDefault(RegistryUtils.getRegistryType(registryClass), RegistryDisplays$IIcon.b);
    }
