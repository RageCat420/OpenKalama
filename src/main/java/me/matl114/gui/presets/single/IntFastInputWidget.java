...
public class IntFastInputWidget extends KalamaHelperHelperCX {
    ...
    public static IntFastInputWidget instance(
            ...
            int dy,
            int dx0) {
        return (IntFastInputWidget)
                (keyValue instanceof AttrKeyValues.ClampedIntAttrKeyValue var7 && var7.getMin() <= 1
    ...
    protected void bp() {
        ExecutableWidget.instance(this.dx + 6, -30, 24, 24)
                .<ExecutableWidget>eV(IconElement.cm(ai, ButtonAction.a(this::br))
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.int-fast-input-widget.cancel-gui.tooltips", "")))
                        .ag(i -> this.aD != null))
                .addToSub(this);
        ExecutableWidget.instance(-30, -30, this.dx + 60, this.dy + 60)
                .<ExecutableWidget>eV(PlateElement.ch().cF(KalamaHelperHelperP.ax((el, am) -> {
    ...
    protected void bo() {
        DisplayWidget.instance(this.aB - 2, 3, this.dx - this.aB + 2, this.dy - 6)
                .<DrawableWidget>setRenderHandler(PlateElement.cg())
                .addToSub(this);
        ExecutableWidget.instance(this.aB + 2, 7, this.dx - this.aB - 6, this.dy - 14)
                .<ExecutableWidget>eV(new ButtonElement(TextProvider.c(aK), ButtonAction.a(this::bq))
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.int-fast-input-widget.confirm.tooltips", "")))
