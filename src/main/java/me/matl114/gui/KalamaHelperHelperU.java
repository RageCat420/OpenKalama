...
public class KalamaHelperHelperU<T> extends TextFieldWidget {
   ...
   public KalamaHelperHelperU(AttrKeyValue<T> attrKeyValue, TextRenderer textRenderer, int x, int y, int width, int height) {
      ...
      TextFieldAccess.of(this).setBorderColorProvider(McWidgetHelpers.getWrongRedTextBoxColorProvider(this.dC::isValidate));
   }
