...
public class PageButtonElement extends ButtonElement {
   ...
   public void renderTexture(VDrawContext context, DrawableWidget element, boolean highlight) {
      ...
      context.u(this.delta < 0 ? s : t, (int)var6, (int)var7, 0, (int)(element.getTextureWidth() - var6), (int)(element.getTextureHeight() - var7));
   }

   public static PageButtonElement aa(IntSupplier maxPage, IntSupplier page, IntConsumer set) {
      return new PageButtonElement(ChatUtils.parseTranslation("widget.gui.page-button-element.prev.tooltips", ""), maxPage, page, set, -1);
   }
   ...
   public static PageButtonElement ab(IntSupplier maxPage, IntSupplier page, IntConsumer set) {
      return new PageButtonElement(ChatUtils.parseTranslation("widget.gui.page-button-element.next.tooltips", ""), maxPage, page, set, 1);
   }
