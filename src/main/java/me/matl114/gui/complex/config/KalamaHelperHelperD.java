...
public class KalamaHelperHelperD extends ScrollableListWidget {
    ...
    protected <T extends Element & Drawable & Selectable> KalamaHelperHelperCX dR(
            T widget, int listIndex, int startX, int startY) {
        int var5 = this.t.b();
        int var6 = this.t.c();
        Object var8 = widget instanceof DrawableWidget var7
                ? var7
                : new ContentDelegateWidget(0, 0, var6, var5).setContentDelegate(widget);
        ...
        return new KalamaHelperHelperCX(startX, var11, var6, var5)
                ...
                .Q(ExecutableWidget.instance(var6 + 1, 1 + var10, var9 - 2, var9 - 2)
                        .eV(IconElement.cm(da, ButtonAction.a(() -> this.t.d(listIndex)))
                                .setActive(listIndex != 0)
                                .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
                                        "widget.gui.list-modify-widget.shift-up.tooltips", "")))))
                .Q(ExecutableWidget.instance(var6 + var9 + 1, 1 + var10, var9 - 2, var9 - 2)
                        .eV(IconElement.cm(db, ButtonAction.a(() -> this.t.e(listIndex)))
                                .setActive(listIndex != this.t.a() - 1)
                                .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
                                        "widget.gui.list-modify-widget.shift-down.tooltips", "")))))
                .Q(ExecutableWidget.instance(var6 + 2 * var9 + 1, 1 + var10, var9 - 2, var9 - 2)
                        .eV(IconElement.cm(dc, ButtonAction.a(() -> this.t.f(listIndex)))
                                .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
                                        "widget.gui.list-modify-widget.delete.tooltips", "")))))
                .Q(ExecutableWidget.instance(var6 + 3 * var9 + 1, 1 + var10, var9 - 2, var9 - 2)
                        .eV(IconElement.cm(dd, ButtonAction.a(() -> this.t.g(listIndex)))
                                .aO(TooltipHandler.ap(dQ()))));
    }
    ...
    protected ExecutableWidget dS(int startX, int startY) {
        ...
        return ExecutableWidget.instance(
                        startX + var4 / 2 - var5 / 2 + 2 * var5, startY + var3 * this.t.a(), var5, var5)
