...
public class TradeInformationSubScreen extends KalamaHelperHelperCX {
    ...
    protected void init() {
        ExecutableWidget.instance(1, 1, 18, 18)
                .<ExecutableWidget>eV(new SlotElement(
                                InventoryUtils.b(() -> {
                        ...
                        .ag(this::active))
                .addToSub(this);
        ExecutableWidget.instance(21, 1, 18, 18)
                .<ExecutableWidget>eV(new SlotElement(
                                InventoryUtils.b(() -> {
                                    TradeOffer var1 = this.getCurrentTrade();
                        ...
                        .ag(this::active))
                .addToSub(this);
        DisplayWidget.instance(40, 5, 10, 9)
                .<DrawableWidget>setRenderHandler(IconElement.co(ep, eo, ButtonAction.c(), el -> {
                        ...
                        .aO(TooltipHandler.ar(() -> {
                            ...
                            if (var1 == null) {
                                ...
                                var2.add(Text.translatable("widget.fast-trade.trade-info.0")
                                        .formatted(Formatting.AQUA));
                                var2.add(Text.translatable("widget.fast-trade.trade-info.1")
                                        .formatted(Formatting.GREEN));
                                var2.add(Text.literal("------------------").formatted(Formatting.GREEN));
                                var2.add(Text.translatable(
                                        "widget.fast-trade.trade-info.max-trade",
                                        new Object[] {String.valueOf(var1.getMaxUses())}));
                                var2.add(Text.translatable(
                                        "widget.fast-trade.trade-info.current-trade",
                                        new Object[] {String.valueOf(var1.getUses())}));
                                var2.add(Text.translatable("widget.fast-trade.trade-info.default-count", new Object[] {
                                    String.valueOf(var1.getFirstBuyItem().count())
                                }));
                                var2.add(Text.translatable(
                                        "widget.fast-trade.trade-info.price-multiplier",
                                        new Object[] {"%.2f".formatted(var1.getPriceMultiplier())}));
                                var2.add(Text.translatable(
                                        "widget.fast-trade.trade-info.demand-bonus",
                                        new Object[] {String.valueOf(var1.getDemandBonus())}));
                                var2.add(Text.translatable(
                                        "widget.fast-trade.trade-info.special-price",
                                        new Object[] {String.valueOf(var1.getSpecialPrice())}));
                                return var2.build();
                            }
                        }))
                        .ag(this::active))
                .addToSub(this);
        ExecutableWidget.instance(51, 0, 18, 18)
                .<ExecutableWidget>eV(new SlotElement(
                                InventoryUtils.b(() -> {
                                    TradeOffer var1 = this.getCurrentTrade();
                        ...
                        .ag(this::active))
                .addToSub(this);
        ExecutableWidget.instance(71, 0, 18, 8)
                .<ExecutableWidget>eV(new ButtonElement(TextProvider.c(er), ButtonAction.a(() -> {
                        ...
                        .aO(TooltipHandler.ap(es)))
                .addToSub(this);
        ExecutableWidget.instance(71, 12, 18, 8)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(et),
                                ButtonAction.a(
                                        HotKeyUtils.wrapFlagAsToggle("fast-craft.drop-craft", InvTasks.ah().dropCraft)))
                        .aO(TooltipHandler.ap(eu)))
                .addToSub(this);
        DisplayWidget.instance(10, 0, 50, 20)
                .<DrawableWidget>setRenderHandler(LabelElement.instance(
