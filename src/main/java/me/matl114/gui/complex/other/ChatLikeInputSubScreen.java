...
public class ChatLikeInputSubScreen extends KalamaHelperHelperCX {
   ...
   public void setChatFromHistory(int offset) {
      ...
      if (var2 != this.messageHistoryIndex) {
         if (var2 == var3) {
            ...
            ((TextFieldWidget)(Object)this.eL.ef()).setText((String)(Object)this.bT.inGameHud.getChatHud().getMessageHistory().get(var2));
   ...
   public void renderInDefaultMatrix(VDrawContext context, int mouseX, int mouseY, float delta, boolean disableSelect) {
      context.fill(0, -2, this.eL.getWidth(), this.eL.getHeight() - 2, this.bT.options.getTextBackgroundColor(Integer.MIN_VALUE));
      RenderHandler.K(context, -1, -3, this.eL.getWidth() + 2, this.eL.getHeight() + 2, this.isFocused() ? -1 : -8355712);
   ...
   public void resetHistoryIndex() {
      this.messageHistoryIndex = this.bT.inGameHud.getChatHud().getMessageHistory().size();
   }
}
