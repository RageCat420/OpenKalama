...
public class KalamaHelperHelperN<T> extends ConfirmingBigScreen {
   ...
   protected KalamaHelperHelperN(ComponentType<T> type, NbtElement currentValue, Consumer<NbtElement> callback) {
      ...
      this.dY = new NbtAttrKeyValue<Optional<T>>(
            ...
            nbt -> nbt == null
               ? Optional.empty()
               : Optional.of((T)((Pair)(Object)this.ea.getCodec().decode(RegistryOps.of(NbtOps.INSTANCE, ItemStackUtils.registry()), nbt).getOrThrow()).getFirst())
         )
         .setEnableNull(true);
      this.c = callback;
      this.setTitleLabel(
   ...
   protected void init() {
      ...
      try {
         String var2 = "https://zh.minecraft.wiki/w/%E6%95%B0%E6%8D%AE%E7%BB%84%E4%BB%B6#" + Registries.DATA_COMPONENT_TYPE.getId(this.ea).getPath();
         var1 = Util.validateUri(var2);
      } catch (Throwable var4) {
      }

      URI var5 = var1;
      MutableText var3 = Text.translatable("widget.gui.item-edit-screen.nbt-editor.component.component-edit-screen.open-wiki");
      this.eb = ExecutableWidget.instance(this.x + 5, this.y + 22, this.backgroundWidth - 10, 12)
         .<ExecutableWidget>eV(LabelElement.instance(var3).cF(me.matl114.gui.basic.KalamaHelperHelperP.aA(() -> {
            if (var5 != null) {
      ...
      this.bu = (EditBoxWidget)(Object)this.dY
         ...
         .ef();
      this.bt = ExecutableWidget.instance(this.x + ItemEditScreen.CONTENT_START_X + 1, this.y + CONTENT_START_Y + 1, 18, 18)
         .<ExecutableWidget>eV(IconElement.cm(KalamaHelperHelperE.FORMAT_TEXTURE_SPRITE, ButtonAction.a(() -> this.dY.applyFormatting(str -> {
            if (this.bu != null) {
               this.bu.setText(str);
            }
