...
public class KalamaHelperHelperL extends KalamaHelperHelperJ {
   ...
   protected void refreshScreen() {
      ...
      for (KalamaHelperHelperK var4 : KalamaHelperHelperK.values()) {
         ...
         ExecutableWidget.instance(20, var4.ordinal() * 30, 80, 30)
            .<ExecutableWidget>eV(new ButtonElement(el -> this.dR == var4 ? var5 : var6, ButtonAction.a(() -> this.setCurrentAttr(var4))))
            .addToSub(this);
      }

      DisplayWidget.instance(30, this.bw.ci.getTextureHeight() - 90, 60, 20)
         .<DrawableWidget>setRenderHandler(LabelElement.instance(Text.translatable("widget.gui.item-edit-screen.nbt-editor.refresh-item")))
         .addToSub(this);
   ...
   protected KalamaHelperHelperQ generateCurrentAttrScreen() {
      return (KalamaHelperHelperQ)(switch (this.dR) {
   ...
   public KalamaHelperHelperL(final ItemEditScreen this$0) {
      ...
      this$0.setTitleLabel(Text.translatable("widget.gui.item-edit-screen.nbt-editor").formatted(Formatting.GREEN));
      this.af();
   }
