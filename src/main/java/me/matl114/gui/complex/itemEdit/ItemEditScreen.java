...
public class ItemEditScreen extends ConfirmingBigScreen {
    ...
    protected void setState(KalamaHelperHelperI state) {
        ...
        if (state == null) {
            this.setTitleLabel(Text.translatable("widget.gui.item-edit-screen.state.error-title")
    ...
    protected void init() {
        ...
        this.bW = ExecutableWidget.instance(this.x + CONTENT_START_X + 1, this.y + CONTENT_START_Y + 1, 18, 18)
                .<ExecutableWidget>eV(IconElement.cm(cb, ButtonAction.a(this::dj))
        ...
        this.bX = ExecutableWidget.instance(this.x + CONTENT_START_X + 21, this.y + CONTENT_START_Y + 1, 18, 18)
                .<ExecutableWidget>eV(IconElement.cm(cc, ButtonAction.a(this::executeSave))
                        .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
        ...
        this.bY = ExecutableWidget.instance(this.x + CONTENT_START_X + 41, this.y + CONTENT_START_Y + 1, 18, 18)
                .<ExecutableWidget>eV(IconElement.cm(cd, ButtonAction.a(() -> this.setState(KalamaHelperHelperI.DR)))
                        .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
        ...
        this.bZ = ExecutableWidget.instance(this.x + CONTENT_START_X + 61, this.y + CONTENT_START_Y + 1, 18, 18)
                .<ExecutableWidget>eV(IconElement.cm(ce, ButtonAction.a(() -> this.setState(KalamaHelperHelperI.DP)))
                        .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
        ...
        this.ca = ExecutableWidget.instance(this.x + CONTENT_START_X + 81, this.y + CONTENT_START_Y + 1, 18, 18)
                .<ExecutableWidget>eV(IconElement.cm(cf, ButtonAction.a(SlimefunTasks.w()::adZ))
                        .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
    ...
    public void applyChangeToInventory() {
        if (mc.player != null) {
            if (mc.interactionManager != null
                ...
                Debug.b(Text.translatable("widget.gui.item-edit-screen.save.apply-changes.creative")
                        .formatted(Formatting.GREEN));
                int var2 = InventoryUtils.getSelectedSlot();
                InvTasks.setCreativeInventory(this.v, var2);
            } else {
                Debug.b(Text.translatable("widget.gui.item-edit-screen.save.apply-changes.command")
                        .formatted(Formatting.YELLOW));
                String var1 = InvTasks.createGiveCommand(this.v.copy());
                if (var1.length() >= 256) {
                    Debug.b(Text.translatable("widget.gui.item-edit-screen.save.apply-changes.command.too-long")
                            .formatted(Formatting.RED));
