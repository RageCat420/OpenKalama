...
public class KalamaHelperHelperH extends KalamaHelperHelperQ {
   ...
   protected void init() {
      ...
      var1.getEnchantmentEntries()
         .forEach(var -> this.cY.add(new KalamaHelperHelperO(ItemStackUtils.solveDynamic((RegistryEntry)var.getKey()).toString(), var.getIntValue())));
      new me.matl114.gui.complex.config.KalamaHelperHelperD(
            ListEntryWidgetController.mutable(this.cY, () -> new KalamaHelperHelperO("minecraft:", 0), KalamaHelperHelperO::a, 20, 180),
            10,
            0,
            260,
