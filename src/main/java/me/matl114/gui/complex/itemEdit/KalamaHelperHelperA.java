...
public class KalamaHelperHelperA {
    ...
    public DrawableWidget factory() {
        return new KalamaHelperHelperCX(0, 0, 0, 0)
                ...
                .Q(DisplayWidget.instance(120, 0, 30, 20)
                        .setRenderHandler(new LabelElement(
                                ...
                                -1,
                                0)))
                .Q(ExecutableWidget.instance(150, 0, 30, 20)
    ...
    public <T> KalamaHelperHelperA(ComponentType<T> type, Optional<T> data) {
        this.a = AttrKeyValue.registry(
                "widget.gui.item-edit-screen.nbt-editor.component.type", Registries.DATA_COMPONENT_TYPE, type);
        this.b = data.isPresent()
                ? (NbtElement) type.getCodec()
        ...
        try {
            ...
            if (var2 != null) {
                if (this.b == null) {
                    ...
                    DataResult var3 =
                            var2.getCodec().decode(RegistryOps.of(NbtOps.INSTANCE, ItemStackUtils.registry()), this.b);
    ...
    public KalamaHelperHelperA(String newId) {
        this.a = AttrKeyValue.openRegistry(
                "widget.gui.item-edit-screen.nbt-editor.component.type", Registries.DATA_COMPONENT_TYPE, newId);
        this.b = null;
    }
    ...
    protected void openThisEditScreen() {
        ...
        if (var1 != null) {
            ScreenAccess.of(new KalamaHelperHelperN<>(var1, this.b, nbt -> this.b = nbt == null ? null : nbt.copy()))
                    .openFromCurrent();
        }
    }
}
