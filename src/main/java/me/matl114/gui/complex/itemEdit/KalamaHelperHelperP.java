...
public class KalamaHelperHelperP {
   ...
   public KalamaHelperHelperP(final KalamaHelperHelperC this$2, String attribute, EntityAttributeModifier modifier, AttributeModifierSlot slot) {
      this.b = AttrKeyValue.openRegistry("widget.gui.item-edit-screen.nbt-editor.attribute.name", Registries.ATTRIBUTE, attribute);
   ...
   public KalamaHelperHelperP(final KalamaHelperHelperC this$2) {
      this(
         this$2,
         "minecraft:",
         new EntityAttributeModifier(Identifier.tryParse("minecraft:" + UUID.randomUUID().toString()), 0.0, Operation.ADD_VALUE),
      ...
      try {
         ...
         if (var1 != null) {
            ...
            if (var2 != null && var2.value() != null) {
               EntityAttributeModifier var3 = new EntityAttributeModifier(this.a.getOriginValue(), this.c.getOriginValue(), this.d.getOriginValue());
