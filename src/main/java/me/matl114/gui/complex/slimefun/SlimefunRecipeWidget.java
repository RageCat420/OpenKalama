...
public class SlimefunRecipeWidget extends KalamaHelperHelperCX {
   ...
   public SlimefunRecipeWidget(int x, int y, IRecipeEntry entry, BiConsumer<ItemStack, Boolean> itemClickEvent, BiConsumer<String, Boolean> rtypeClickEvent) {
      super(x, y, 144, 64);
      this.ab = entry.Co();
   ...
   private final void init0() {
      ...
      for (int var1 = 0; var1 < 3; var1++) {
         for (int var2 = 0; var2 < 3; var2++) {
            ...
            ExecutableWidget.instance(15 + 18 * var2, 5 + 18 * var1, 18, 18)
               .<ExecutableWidget>eV(new SlotElement(this.ad, var3).cF(KalamaHelperHelperP.au(t -> this.ae.accept(this.ad.getStack(var3), t))))
               .addToSub(this);
         }
      }

      ExecutableWidget.instance(109, 23, 18, 18)
         .<ExecutableWidget>eV(new OutputSlotElement(this.ac).cF(KalamaHelperHelperP.au(t -> this.ae.accept(this.ac, t))))
         .addToSub(this);
      ExecutableWidget.instance(78, 23, 18, 18)
         .<ExecutableWidget>eV(SlotElement.aI(this.aa).aK(false).cF(KalamaHelperHelperP.au(t -> this.af.accept(this.ab, t))))
         .addToSub(this);
      ...
      if (var5) {
         ExecutableWidget.instance(var7 + var4 * 12, 44, 9, 9)
            .<ExecutableWidget>eV(
               new ButtonElement(TextProvider.c(Text.literal("G")), ButtonAction.a(() -> InvTasks.creativeAddItem(this.ac.copy(), 64)))
                  .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-recipe-widget.creative-give.tooltips", "")))
            )
            .addToSub(this);
         var4++;
      }
      ...
      ExecutableWidget.instance(var7 + var4 * 12, 44, 9, 9)
         .<ExecutableWidget>eV(
            new ButtonElement(TextProvider.c(Text.literal("E")), ButtonAction.a(() -> InvTasks.Y(this.ac.copy(), null)))
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-recipe-widget.open-editor.tooltips", "")))
         )
         .addToSub(this);
      ExecutableWidget.instance(var7 + ++var4 * 12, 44, 9, 9)
         .<ExecutableWidget>eV(
            new ButtonElement(TextProvider.c(Text.literal("+")), ButtonAction.a(() -> InvTasks.aq().removeSavedItem(this.ac.copy())))
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-recipe-widget.save-item.tooltips", "")))
         )
         .addToSub(this);
      ExecutableWidget.instance(128, 0, 16, 16)
         .<ExecutableWidget>eV(
            IconElement.cm(CANCEL_GUI_TEXTURE, ButtonAction.a(this::aH))
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-recipe-widget.close-sub-screen.tooltips", "")))
               .ag(i -> this.ah != null)
         )
         .addToSub(this);
      ExecutableWidget.instance(0, 0, 144, 64).<ExecutableWidget>eV(PlateElement.ch()).addToSub(this, -1);
   }
}
