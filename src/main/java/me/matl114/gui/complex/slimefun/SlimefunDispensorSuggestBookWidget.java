...
public class SlimefunDispensorSuggestBookWidget extends KalamaHelperHelperCX {
   ...
   protected static final Text fn = Text.translatable("widget.gui.slimefun-dispensor-suggest-book-widget.multiblock-execute");
   int aX;
   protected static final Text fm = Text.translatable("widget.gui.slimefun-dispensor-suggest-book-widget.refresh-soft");
   ...
   protected static final Text fo = Text.translatable("widget.gui.slimefun-dispensor-suggest-book-widget.multiblock-auto");
   ...
   protected static final Text fl = Text.translatable("widget.gui.slimefun-dispensor-suggest-book-widget.refresh-hard");
   ...
   protected void openInputIntScreen(int originValue, IntConsumer intCallback) {
      if (this.ba != null) {
         BaseAttrKeyValue var3 = AttrKeyValue.clampedInt("widget.gui.slimefun-dispensor-suggest-book-widget.input-count", originValue, 0, 64);
         IntFastInputWidget var4 = IntFastInputWidget.instance(var3, attr -> intCallback.accept(attr.getOriginValue()), 0, 16, 96, 30, 64)
   ...
   public ExecutableWidget gE(IRecipeEntry recipeEntry) {
      return ExecutableWidget.instance(0, 0, 12, 12).eV(SlotElement.aI(recipeEntry.Ct()).cF(new KalamaHelperHelperF(this, recipeEntry)).ag(this::active));
   }
   ...
   public SlimefunDispensorSuggestBookWidget(TileInventory tile, int x, int y, Collection<String> optionalType, BiConsumer<Integer, IRecipeEntry> callback) {
      super(x, y, 168, 75);
      this.aX = 1;
      this.aW = 1;
      this.fC = callback;
   ...
   public void af() {
      this.fp = ExecutableWidget.instance(0, 0, 8, 8)
         .<ExecutableWidget>eV(
            SlotElement.aI(fj)
               ...
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.book.tooltips", "")))
         )
         .addToSub(this);
      this.ba = new ContentDelegateWidget(36, 14, 96, 42).addToSub(this, 500);
      this.fs = ExecutableWidget.instance(12, 0, 18, 8).<ExecutableWidget>eV(new ButtonElement(el -> fJ ? fl : fm, ButtonAction.a(() -> {
         fJ = !fJ;
         Tasks.l(this::gH, 5);
      })).aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.refresh-rule.tooltips", "")))).addToSub(this);
      this.ft = ExecutableWidget.instance(30, 0, 18, 8)
         .<ExecutableWidget>eV(
            new ButtonElement(TextProvider.c(fn), ButtonAction.a(() -> {
                  SlimefunTasks.v().onMultiBlockExecute(MinecraftClient.getInstance().currentScreen, false, false);
                  Tasks.l(this::gH, 2);
               }))
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.multiblock-execute-one.tooltips", "")))
               .ah(el -> MinecraftClient.getInstance().currentScreen instanceof TileInventory var2 && !var2.isVirtual())
         )
         .addToSub(this);
      this.fq = ExecutableWidget.instance(52, 0, 8, 8)
         .<ExecutableWidget>eV(PageButtonElement.aa(this::cn, this::cq, this::setPage).ag(this::active))
         .addToSub(this);
      this.fr = ExecutableWidget.instance(108, 0, 8, 8)
         .<ExecutableWidget>eV(PageButtonElement.ab(this::cn, this::cq, this::setPage).ag(this::active))
         .addToSub(this);
      this.fu = ExecutableWidget.instance(60, 0, 48, 8)
         .<ExecutableWidget>eV(
            new LabelElement(bz, -1)
               .cF(KalamaHelperHelperP.aA(() -> {
                  this.onlyShowRelated = !this.onlyShowRelated;
                  Tasks.l(this::gH, 5);
               }))
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.title.show-related.tooltips", "")))
               .ag(this::active)
         )
         .addToSub(this);
      this.fx = ExecutableWidget.instance(160, 0, 8, 8)
         .<ExecutableWidget>eV(
            SlotElement.aI(fk)
               ...
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.refresh.tooltips", "")))
               .ag(this::active)
         )
         .addToSub(this);
      this.fv = ExecutableWidget.instance(120, 0, 18, 8)
         .<ExecutableWidget>eV(
            new ButtonElement(TextProvider.c(fn), ButtonAction.a(() -> {
                  SlimefunTasks.v().onMultiBlockExecute(MinecraftClient.getInstance().currentScreen, true, ScreenUtils.hasShiftDown());
                  Tasks.l(this::gH, 5);
               }))
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.multiblock-execute.tooltips", "")))
               .ah(el -> MinecraftClient.getInstance().currentScreen instanceof TileInventory var2 && !var2.isVirtual())
         )
         .addToSub(this);
      this.fw = ExecutableWidget.instance(138, 0, 18, 8)
         .<ExecutableWidget>eV(
            new ButtonElement(TextProvider.c(fo), (element, widget, mouseButton) -> {
               ...
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-dispensor-suggest-book-widget.multiblock-auto.tooltips", "")))
               .ah(el -> MinecraftClient.getInstance().currentScreen instanceof TileInventory var2 && !var2.isVirtual())
         )
      ...
      this.fy = FilterService.createFilter(ValueAccessor.of(() -> fK, s -> fK = s), v -> {
         if (this.refreshFilter()) {
            this.resetPage();
         }
      }, 57, 68, 56, 7);
      this.fz = new ContentDelegateWidget<DrawableWidget>(0, 0, 0, 0).setContentDelegate(fG ? this.fy : (DrawableWidget)null).addToSub(this);
      this.gA();
   }
