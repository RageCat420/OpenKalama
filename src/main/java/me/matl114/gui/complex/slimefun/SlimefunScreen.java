...
public class SlimefunScreen extends GenericBackGroundScreen {
   ...
   protected void init() {
      ...
      this.ey = ExecutableWidget.instance(this.x - 19, this.y + 16, 18, 18)
         .<DrawableWidget>setRenderHandler(
            SlotElement.aI(SlimefunTasks.b).aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-screen.all-item.tooltips", "")))
         )
         .addTo(this);
      this.ez = ExecutableWidget.instance(this.x - 19, this.y + 42, 18, 18)
         .<DrawableWidget>setRenderHandler(
            SlotElement.aI(SlimefunTasks.c).aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-screen.all-type.tooltips", "")))
         )
         .addTo(this);
      this.eC = ExecutableWidget.instance(this.x - 19, this.y + 68, 18, 18)
         .<DrawableWidget>setRenderHandler(
            SlotElement.aI(SlimefunTasks.d).aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-screen.all-vanilla.tooltips", "")))
         )
         .addTo(this);
      this.eD = ExecutableWidget.instance(this.x - 19, this.y + 94, 18, 18)
         .<DrawableWidget>setRenderHandler(
            SlotElement.aI(SlimefunTasks.e).aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-screen.all-custom.tooltips", "")))
         )
         .addTo(this);
   ...
   @Override
   protected void l() {
      this.ev = DisplayWidget.instance(this.x - 23, this.y + 12, 26, 26).<DrawableWidget>setRenderHandler(PlateElement.cg()).addTo(this);
      this.ew = DisplayWidget.instance(this.x - 23, this.y + 38, 26, 26).<DrawableWidget>setRenderHandler(PlateElement.cg()).addTo(this);
      this.ex = DisplayWidget.instance(this.x - 23, this.y + 64, 26, 26).<DrawableWidget>setRenderHandler(PlateElement.cg()).addTo(this);
      DisplayWidget.instance(this.x - 23, this.y + 90, 26, 26).<DrawableWidget>setRenderHandler(PlateElement.cg()).addTo(this);
      this.eA = ExecutableWidget.instance(this.x + this.backgroundWidth - 3, this.y + 12, 26, 26)
         ...
         .<DrawableWidget>setRenderHandler(
            PlateElement.cg()
               ...
               .aO(TooltipHandler.ap(ChatUtils.parseTranslation("widget.gui.slimefun-screen.close-screen.tooltips", "")))
         )
         .addTo(this);
      this.eB = ExecutableWidget.instance(this.x + this.backgroundWidth - 3, this.y + 38, 26, 26)
         .<ExecutableWidget>eT(KalamaHelperHelperP.aA(this::close))
         .<DrawableWidget>setRenderHandler(PlateElement.cg().cD(RenderHandler.z(eE, 4, 4, 18, 18)).aO(TooltipHandler.ar(this::getSearchButtonTooltips)))
         .addTo(this);
      super.l();
   }
}
