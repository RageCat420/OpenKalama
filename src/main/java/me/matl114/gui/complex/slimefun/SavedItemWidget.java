...
public class SavedItemWidget extends KalamaHelperHelperCX {
    ...
    private final void init0() {
        DisplayWidget.instance(0, 0, 144, 64)
        ...
        ExecutableWidget.instance(75, 12, 25, 16)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.translatable("widget.gui.saved-item-widget.open-editor")),
                                ButtonAction.a(() -> InvTasks.Y(this.v, null)))
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.saved-item-widget.open-editor.tooltips", ""))))
                .addToSub(this);
        ExecutableWidget.instance(75, 36, 25, 16)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.translatable("widget.gui.saved-item-widget.creative-give")),
                                ButtonAction.a(() -> {
                                    if (MinecraftClient.getInstance().player != null
                                        ...
                                        Debug.b(Text.translatable("widget.gui.saved-item-widget.creative-give.error")
                                                .formatted(Formatting.YELLOW));
                                    }
                                }))
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.saved-item-widget.creative-give.tooltips", ""))))
                .addToSub(this);
        ExecutableWidget.instance(105, 12, 25, 16)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.translatable("widget.gui.saved-item-widget.delete-item")),
                                ButtonAction.a(() -> InvTasks.aq().removeSavedItem(this.v)))
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.saved-item-widget.delete-item.tooltips", ""))))
                .addToSub(this);
        ExecutableWidget.instance(105, 36, 25, 16)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.translatable("widget.gui.saved-item-widget.copy-command")),
                                ButtonAction.a(() -> InvTasks.copyGiveCommand(this.v)))
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.saved-item-widget.copy-command.tooltips", ""))))
                .addToSub(this);
    }
}
