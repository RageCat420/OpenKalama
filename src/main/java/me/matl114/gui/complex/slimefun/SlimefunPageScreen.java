...
public abstract class SlimefunPageScreen extends SlimefunScreen {
    ...
    protected final PageSwitchSubScreen aN =
            new PageSwitchSubScreen(0, 20, this.backgroundWidth, 12, this.getPageContentHeight(), i -> this.bC());
    protected static final int PAGE_LABEL_HEIGHT = 12;

    protected void bE() {
        this.aO = new ContentDelegateWidget<PageSwitchSubScreen>(this.x, this.y, 0, 0)
                .setContentDelegate(this.aN)
                .addTo(this);
    }
