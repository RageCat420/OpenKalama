...
public abstract class SlimefunEntryListScreen<T> extends SlimefunPageScreen {
    ...
    protected void init() {
        ...
        for (int var4 = 0; var4 < this.entryPerPage; var4++) {
            this.pageContent[var4] =
                    new ContentDelegateWidget(this.x + var3, this.y + 32 + 4 + 68 * var4, 64, 64).addTo(this);
        }
    ...
    protected void bC() {
        ...
        for (int var4 = 0; var4 < this.entryPerPage; var4++) {
            if (this.pageContent[var4] == null) {
                ...
                this.pageContent[var4] =
                        new ContentDelegateWidget(this.x + var5, this.y + 32 + 4 + 68 * var4, 64, 64).addTo(this);
            }
