...
public class FilterService {
    ...
    public static BiPredicate<String, ItemStack> b = (str, i) ->
            str != null && !str.isEmpty() ? nameMatch(i.getName().getString().replaceAll("§.", ""), str) : true;
    ...
    public static boolean nameMatch(String name, String filter) {
        if (filter != null && !filter.isEmpty()) {
            ...
            if (name.contains(filter)) {
                ...
                String var2 =
                        PinyinHelper.toPinyin(name, PinyinStyleEnum.INPUT, "").toLowerCase(Locale.ROOT);
                if (var2.contains(filter)) {
                    return true;
                } else {
                    var2 = PinyinHelper.toPinyin(name, PinyinStyleEnum.FIRST_LETTER, "")
    ...
    public static KalamaHelperHelperCX createFilter(
            ValueAccessor<String> accessor, Consumer<String> updateListener, int x, int y, int dx, int dy) {
        ContentDelegateWidget var6 = McWidgetHelpers.c(
                dy,
                0,
                dx - dy,
                dy,
        ...
        DrawableWidget var7 = DisplayWidget.instance(0, 0, dy, dy)
                .setRenderHandler(new ButtonElement(TextProvider.c(Text.empty()), ButtonAction.c())
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.filter-service.reset-filter.tooltips", ""))));
        ExecutableWidget var8 = ExecutableWidget.instance(0, 0, dy, dy)
                .eV(IconElement.cm(d, ButtonAction.a(() -> {
                            if (var6.ef() != null) {
    ...
    public static KalamaHelperHelperCX b(
    ...
    public static KalamaHelperHelperCX d(
    ...
    public static KalamaHelperHelperCX createFilterWithRegex(
        ...
        DrawableWidget var8 = DisplayWidget.instance(0, 0, dy, dy)
                .setRenderHandler(new ButtonElement(TextProvider.c(Text.empty()), ButtonAction.c())
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.filter-service.reset-filter.tooltips", ""))));
        ExecutableWidget var9 = ExecutableWidget.instance(0, 0, dy, dy)
                .eV(IconElement.cm(d, ButtonAction.a(() -> {
                            if (var7.ef() != null) {
                        ...
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.filter-service.reset-filter.tooltips", ""))));
        ExecutableWidget var10 = ExecutableWidget.instance(dx - dy, 0, dy, dy)
                .eV(new ButtonElement(
                        ...
                        .cw(el -> (Boolean) useRegex.getValue())
                        .aO(TooltipHandler.ap(
                                ChatUtils.parseTranslation("widget.gui.filter-service.use-regex.tooltips", ""))));
