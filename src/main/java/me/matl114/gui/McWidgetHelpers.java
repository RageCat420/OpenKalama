...
public class McWidgetHelpers {
   ...
   public static void drawTextWidgetBox(
      Drawable drawable, DrawContext context, int x, int y, int width, int height, boolean focus, KalamaHelperHelperIX borderColor
   ) {
   ...
   public static ContentDelegateWidget<TextFieldWidget> createAttrValueEditBox(AttrKeyValue<?> attrKeyValue, int x, int y, int dx, int dy) {
      return new KalamaHelperHelperE(x, y, new KalamaHelperHelperU(attrKeyValue, a.textRenderer, 0, 0, dx, dy));
   }

   public static ContentDelegateWidget<EditBoxWidget> a(int x, int y, int dx, int dy, PropertyTracker<EditBoxWidget, String> valueTracker, String origin) {
      return createEnhancedMultiLine(x, y, dx, dy, valueTracker, origin, null);
   }

   public static ContentDelegateWidget<EditBoxWidget> b(
      int x, int y, int dx, int dy, PropertyTracker<EditBoxWidget, String> valueTracker, String origin, KalamaHelperHelperIX boxColorProvider
   ) {
   ...
   public static <T> ContentDelegateWidget<TextFieldWidget> d(
      int x, int y, int dx, int dy, PropertyTracker<T, String> valueTracker, String origin, KalamaHelperHelperIX boxColorProvider
   ) {
   ...
   public static <T> ContentDelegateWidget<TextFieldWidget> c(int x, int y, int dx, int dy, PropertyTracker<T, String> valueTracker, String origin) {
