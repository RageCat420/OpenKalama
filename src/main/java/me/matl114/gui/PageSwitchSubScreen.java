...
public class PageSwitchSubScreen extends KalamaHelperHelperCX {
    ...
    protected void bE() {
        ExecutableWidget.instance(5 + this.dy + 1, 0, this.dx - 5 - 5 - 2 - 2 * this.dy, this.dy)
                .<ExecutableWidget>eV(new AbstractElement()
                        .cD(new LabelElement(i -> Text.literal(this.aX + "/" + this.aW), -1, 0))
                        .cF(KalamaHelperHelperP.ax((w, a) -> {
                            this.updateMaxPage(this.cq() + (a > 0.0 ? -1 : 1));
                            return true;
                        }))
                        .cF(KalamaHelperHelperP.az(this::cs))
                        .aO(TooltipHandler.ap(ChatUtils.parseTranslation(
                                "widget.gui.page-switch-sub-screen.page-label.tooltips", ""))))
                .addToSub(this);
        ExecutableWidget.instance(5, 0, this.dy, this.dy)
                .<ExecutableWidget>eV(PageButtonElement.aa(this::cn, this::cq, this::updateMaxPage))
                .addToSub(this);
    ...
    protected void cs() {
        BaseAttrKeyValue var1 =
                AttrKeyValue.clampedInt("widget.gui.page-switch-sub-screen.input-page", this.aX, 1, this.aW);
        this.ba.setContentDelegate(IntFastInputWidget.instance(
                        var1, this::hoverInputCallback, (this.dx - 96) / 2, (this.aZ - 30) / 2, 96, 30, 64)
