...
public class KalamaHelperHelperCX extends DrawableWidget implements SubSelectable {
   ...
   public Iterable<DrawableWidget> P() {
      return () -> new UnmodifiableListMappingIterator<>(this.A, me.matl114.utils.collections.KalamaHelperHelperK::val);
   }
   ...
   public Iterable<DrawableWidget> O() {
      return () -> new UnmodifiableListMappingIterator<>(this.z, me.matl114.utils.collections.KalamaHelperHelperK::val);
   }
   ...
   private void K() {
      this.z
         .sort(
            Comparator.<me.matl114.utils.collections.KalamaHelperHelperK<DrawableWidget>>comparingInt(s -> s.val().priority)
   ...
   public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
      ...
      return this.C != null
         && this.C.isDragging()
         && this.C.mouseDragged((mouseX - this.getX()) / var10, (mouseY - this.getY()) / var10, button, deltaX / var10, deltaY / var10);
   }
   ...
   private void M(DrawableWidget child) {
      me.matl114.utils.collections.KalamaHelperHelperK var2 = new me.matl114.utils.collections.KalamaHelperHelperK<>(++this.E, child);
      this.z.add(var2);
      this.A.add(var2);
      this.K();
   }
