...
public class ExecutableWidget extends DrawableWidget {
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        return this.handler != null && this.isMouseOver(mouseX, mouseY)
                ? this.handler.b(this, mouseX, mouseY, button, KalamaHelperHelperM.nQ)
                : false;
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        return this.handler != null && this.isMouseOver(mouseX, mouseY)
                ? this.handler.b(this, mouseX, mouseY, button, KalamaHelperHelperM.nP)
                : false;
    }
