...
public interface RenderHandler {
    ...
    static RenderHandler z(Identifier guiTexture, int startX, int startY, int sizeX, int sizeY) {
        return (element, context, mouseX, mouseY, delta, alpha, shouldHighlight) ->
                context.V(guiTexture, startX, startY, sizeX, sizeY);
    }
    ...
    static RenderHandler y(Identifier guiTexture) {
        return (element, context, mouseX, mouseY, delta, alpha, shouldHighlight) ->
                context.V(guiTexture, 0, 0, element.getTextureWidth(), element.getTextureHeight());
    }
    ...
    static RenderHandler ofPositionResource(
    ...
    static RenderHandler ofColorQuad(int color) {
        return (element, context, mouseX, mouseY, delta, alpha, shouldHighlight) ->
                context.E(0, 0, element.getTextureWidth(), element.getTextureHeight(), color, color, 0);
    }
    ...
    void renderAtCentered(
            DrawableWidget var1, VDrawContext var2, int var3, int var4, float var5, float var6, boolean var7);
    ...
    static RenderHandler o(Identifier identifier, int u0, int v0, int uheight, int vheight) {
        ...
        return (element, context, mouseX, mouseY, delta, alpha, shouldHighlight) -> {
            context.setShaderAlpha(alpha);
            context.w(
                    identifier, 0, element.getTextureWidth(), 0, element.getTextureHeight(), 0, var5, var7, var6, var8);
            context.setShaderAlpha(1.0F);
        };
    }
