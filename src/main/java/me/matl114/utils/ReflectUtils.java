...
public class ReflectUtils {
    ...
    public static Field[] getAllFitFields(Class<?> clazz, Class<?> fieldType) {
        if (clazz == null) {
            ...
            var2.addAll(Arrays.stream(getAllFitFields(clazz.getSuperclass(), fieldType))
                    .toList());
                ...
                if (methodName.equals(var7.getName())) {
                    ...
                    if (var8.length == parameterTypes.length) {
                        ...
                        for (int var11 = 0; var11 < var10; var11++) {
                            if (var8[var11] != parameterTypes[var11]
                                    && !var8[var11].isAssignableFrom(parameterTypes[var11])) {
                                var9 = false;
                            }
                        }
                    } else {
