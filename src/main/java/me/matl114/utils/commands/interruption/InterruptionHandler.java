...
public interface InterruptionHandler {
   void handleValueOutOfRange(
      CommandExecution var1, @Nullable ArgumentReader var2, @Nullable String var3, KalamaHelperHelperH var4, String var5, @Nonnull String var6
   );
   ...
   void handleTypeError(CommandExecution var1, @Nullable ArgumentReader var2, @Nullable String var3, KalamaHelperHelperH var4, String var5);
