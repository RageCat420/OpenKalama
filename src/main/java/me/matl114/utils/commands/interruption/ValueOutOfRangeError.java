...
public class ValueOutOfRangeError extends ArgumentException {
   ...
   public ValueOutOfRangeError(ArgumentReader reader, String name, Collection<String> options, String input, KalamaHelperHelperH type) {
      this.lm = reader;
      this.name = name;
   ...
   public ValueOutOfRangeError(ArgumentReader reader, String name, String from, String to, String input, KalamaHelperHelperH type) {
      this.lm = reader;
      this.name = name;
      this.lz = from + " ~ " + to + "(exclusive)";
      this.WA = input;
