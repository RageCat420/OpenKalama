...
public record KalamaHelperHelperB(PlayerEntity sender) implements CommandExecution {
   ...
   public Vector3d getExecutePos() {
      PlayerEntity var1 = this.sender;
      return var1 instanceof PlayerEntity ? new Vector3d(var1.getX(), var1.getY(), var1.getZ()) : new Vector3d(0.0, 0.0, 0.0);
   }
   ...
   public Vector3d sp() { return null; }


   public Vector2f so() { return null; }
