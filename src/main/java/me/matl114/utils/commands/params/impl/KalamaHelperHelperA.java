        ...
        if (!(var3 instanceof PosArgumentResult var4)) {
            ...
            if (var6 != 0 && !var5[0].isEmpty()) {
                ...
                if (var7.startsWith("^")) {
                    ...
                    if (var9) {
                        ...
                        if (var5[var6 - 1].isEmpty()) {
                            int var16 = var8 + 1;
                            return Stream.of(var14, var15)
                                    .map(s -> String.join(" ", Arrays.copyOfRange(s, 3 - var16, 3)));
                        } else {
                ...
                return Stream.of(
                                ...
                                new me.matl114.utils.commands.params.types.KalamaHelperHelperA(
                                        7, new Vector3d(0.0, 0.0, 0.0)),
    ...
    protected ExecutePos d(String xStr, String yStr, String zStr) {
        if (xStr.startsWith("^")) {
            if (yStr.startsWith("^") && zStr.startsWith("^")) {
                ...
                return !Double.isNaN(var4) && !Double.isNaN(var6) && !Double.isNaN(var8)
                        ? new KalamaHelperHelperE(new Vector3d(var4, var6, var8))
                        : null;
            } else {
                return null;
            }
            ...
            return new me.matl114.utils.commands.params.types.KalamaHelperHelperA(
                    var10, new Vector3d(var11, var13, var15));
        }
    }
