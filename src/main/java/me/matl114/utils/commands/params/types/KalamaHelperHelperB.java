...
public record KalamaHelperHelperB(int flag, Vec2f rotation) implements ExecuteRotation {
    ...
    public Vector2f Af(CommandExecution execution) {
        ...
        return new Vector2f(
                (this.flag & 1) != 0 ? var2.x + var3.x : var3.x, (this.flag & 2) != 0 ? var2.y + var3.y : var3.y);
    }
    ...
    public String asString() {
        ...
        return "%s %s"
                .formatted(
                        ExecuteRotation.formatPart((this.flag & 1) != 0, var1.x),
                        ExecuteRotation.formatPart((this.flag & 2) != 0, var1.y));
    }
}
