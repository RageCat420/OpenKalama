...
public class KalamaHelperHelperE<T extends SubCommand> {
   ...
   public <W extends SubCommand> W l(TriFunction<String, KalamaHelperHelperA, String[], W> builder) {
      SubCommand var2 = (SubCommand)builder.apply(this.b, new KalamaHelperHelperA(this.a.toArray(ArgumentType[]::new)), this.c.toArray(String[]::new));
      this.f((T)var2);
      return (W)var2;
   }
   ...
   public T k() {
      SubCommand var1 = (SubCommand)(Object)this.f.apply(this.b, new KalamaHelperHelperA(this.a.toArray(ArgumentType[]::new)), this.c.toArray(String[]::new));
      this.f((T)var1);
      return (T)var1;
   }
