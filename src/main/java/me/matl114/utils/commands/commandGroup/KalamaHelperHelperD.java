...
public interface KalamaHelperHelperD {
    ...
    default <T extends KalamaHelperHelperD> T withFallback(
            SubCommand fallbackCommand, Supplier<Stream<String>> fallbackTabSuggestor) {
        this.setFallbackCommand(
                fallbackCommand, me.matl114.utils.commands.params.api.KalamaHelperHelperF.g(fallbackTabSuggestor));
        return (T) (Object) this;
    }

    SubCommand aA();

    default <R extends KalamaHelperHelperD, W extends SubCommand> KalamaHelperHelperG<R, W> subBuilder(
            KalamaHelperHelperE<W> builder) {
