...
public class KalamaHelperHelperB {
   ...
   public static double g(PlayerEntity player, Entity target, ItemStack stack) {
      ...
      if (var3 != null && !var3.isEmpty()) {
         for (Entry var6 : var3.getEnchantmentEntries()) {
            ...
            } else if (var7.matchesKey(Enchantments.SMITE) && target.getType().isIn(EntityTypeTags.SENSITIVE_TO_SMITE)) {
               var4 += 2.5F * var8;
            } else if (var7.matchesKey(Enchantments.BANE_OF_ARTHROPODS) && target.getType().isIn(EntityTypeTags.SENSITIVE_TO_BANE_OF_ARTHROPODS)) {
               var4 += 2.5F * var8;
            } else if (var7.matchesKey(Enchantments.IMPALING) && target.getType().isIn(EntityTypeTags.SENSITIVE_TO_IMPALING)) {
               var4 += 2.5F * var8;
            }
         }
      }
   ...
   public static double b(RegistryEntry<EntityAttribute> entry, PlayerEntity player, ItemStack stack, EquipmentSlot slot) {
      double var4 = player.getAttributeBaseValue(entry);
      AttributeModifiersComponent var6 = (AttributeModifiersComponent)stack.get(DataComponentTypes.ATTRIBUTE_MODIFIERS);
   ...
   public static double i(PlayerEntity player, Entity livingEntity, ItemStack stack) {
      ...
      AttributeModifiersComponent var5 = (AttributeModifiersComponent)stack.get(DataComponentTypes.ATTRIBUTE_MODIFIERS);
   ...
   public static double e(PlayerEntity player, ItemStack stack) {
      ...
      AttributeModifiersComponent var4 = (AttributeModifiersComponent)stack.get(DataComponentTypes.ATTRIBUTE_MODIFIERS);
