...
public class ASMUtils {
    ...
    public static MethodVisitor createOverrideMethodImpl(ClassWriter cw, Method method) {
        ...
        String[] var3 = var2 != null && var2.length != 0
                ? Arrays.stream(var2).map(Type::getInternalName).toArray(String[]::new)
                : null;
    ...
    public static void f(ClassWriter cw, @Nullable String parentCls) {
        ...
        var2.visitMethodInsn(
                183, parentCls == null ? "java/lang/Object" : parentCls.replace(".", "/"), "<init>", "()V", false);
        var2.visitInsn(177);
        var2.visitMaxs(0, 0);
        var2.visitEnd();
    }
