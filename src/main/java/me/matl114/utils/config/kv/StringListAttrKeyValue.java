...
public class StringListAttrKeyValue extends ListAttrKeyValue<String> {
   public static final AttrKeyValue.CustomWidgetFactory<List<String>> LIST_WIDGET_FACTORY = (s, x, y, inputDx, dy) -> new KalamaHelperHelperCX(
         x, y, inputDx, dy
      )
      .Q(McWidgetHelpers.createAttrValueEditBox(s, 0, 0, inputDx - dy, dy))
      .Q(WidgetUtils.createOpenListModifyScreenButton((StringListAttrKeyValue)s, inputDx - dy + 1, 0, dy - 1, dy));
