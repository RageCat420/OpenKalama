...
public class IntListAttrKeyValue extends ListAttrKeyValue<Integer> {
   public static final AttrKeyValue.CustomWidgetFactory<List<Integer>> LIST_WIDGET_FACTORY = (s, x, y, inputDx, dy) -> new KalamaHelperHelperCX(
         x, y, inputDx, dy
      )
      .Q(McWidgetHelpers.createAttrValueEditBox(s, 0, 0, inputDx - dy, dy))
      .Q(WidgetUtils.createOpenListModifyScreenButton((IntListAttrKeyValue)s, inputDx - dy + 1, 0, dy - 1, dy));
