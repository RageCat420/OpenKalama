...
public class FarmingUtils {
    ...
    static boolean isPitcherHarvestable(World world, BlockPos pos) {
        ...
        if (!var2.isOf(Blocks.PITCHER_CROP)) {
            ...
            return var3.isOf(Blocks.PITCHER_CROP)
                    && var3.get(PitcherCropBlock.HALF) == DoubleBlockHalf.LOWER
                    && (Integer) var3.get(PitcherCropBlock.AGE) >= 4;
        }
    }
        ...
        if (world != null && pos != null && state1 != null && state2 != null) {
            ...
            if (var4 == var5) {
                if (var4 instanceof SlabBlock
                        ...
                        && state2.equals(((BlockState) state1.with(SlabBlock.TYPE, SlabType.DOUBLE))
                ...
                if (var4 instanceof SnowBlock
                        && state2.equals(state1.with(
                                SnowBlock.LAYERS, Math.min(8, (Integer) state1.get(SnowBlock.LAYERS) + 1)))) {
                ...
                if (var4 instanceof CandleBlock) {
                    if ((Integer) state1.get(CandleBlock.CANDLES) < 4
                            && state2.equals(
                                    state1.with(CandleBlock.CANDLES, (Integer) state1.get(CandleBlock.CANDLES) + 1))) {
                    ...
                    if (!(Boolean) state1.get(CandleBlock.LIT)
                            && !(Boolean) state1.get(CandleBlock.WATERLOGGED)
                ...
                if (var4 instanceof SeaPickleBlock
                        ...
                        && state2.equals(state1.with(
                                SeaPickleBlock.PICKLES, (Integer) state1.get(SeaPickleBlock.PICKLES) + 1))) {
                    return Pair.of(g(var4.asItem()), null);
                }
                ...
                if (var4 instanceof FlowerbedBlock
                        ...
                        && state2.equals(state1.with(
                                ...
                                (Integer) state1.get(FlowerbedBlock.FLOWER_AMOUNT) + 1))) {
                    return Pair.of(g(var4.asItem()), null);
                }
                ...
                if (var4 instanceof ComparatorBlock
                        ...
                        && state2.get(ComparatorBlock.MODE)
                                == ((BlockState) state1.cycle(ComparatorBlock.MODE)).get(ComparatorBlock.MODE)
                        && state1.get(ComparatorBlock.FACING) == state2.get(ComparatorBlock.FACING)) {
                    return Pair.of(c, null);
                }

                if (var4 instanceof NoteBlock
                        && state2.equals(
                                state1.with(NoteBlock.NOTE, ((Integer) state1.get(NoteBlock.NOTE) + 1) % 25))) {
                ...
                if (var4 instanceof ButtonBlock
                        && !(Boolean) state1.get(ButtonBlock.POWERED)
                ...
                if (var4 instanceof RespawnAnchorBlock
                        ...
                        && state2.equals(state1.with(
                                RespawnAnchorBlock.CHARGES, (Integer) state1.get(RespawnAnchorBlock.CHARGES) + 1))) {
                ...
                if (var4 instanceof BeehiveBlock
                        && (Integer) state1.get(BeehiveBlock.HONEY_LEVEL) >= 5
            ...
            if (var4 instanceof CakeBlock
                    && var5 instanceof CandleCakeBlock
                    && (Integer) state1.get(CakeBlock.BITES) == 0) {
            ...
            if (var4 instanceof CandleCakeBlock
                    && var5 instanceof CakeBlock
                    && state2.equals(Blocks.CAKE.getDefaultState().with(CakeBlock.BITES, 1))) {
                return Pair.of(c, null);
            } else {
                if (var4 instanceof CandleCakeBlock && var5 instanceof CandleCakeBlock) {
                    if ((Boolean) state1.get(CandleCakeBlock.LIT)
                            && state2.equals(state1.with(CandleCakeBlock.LIT, false))) {
                        return Pair.of(ItemStack::isEmpty, hit(pos, Direction.UP, 0.5, 0.75, 0.5));
                    }

                    if (!(Boolean) state1.get(CandleCakeBlock.LIT)
                            && state2.equals(state1.with(CandleCakeBlock.LIT, true))) {
                        return Pair.of(h(Items.FLINT_AND_STEEL, Items.FIRE_CHARGE), null);
                    }
                }
                ...
                if (var4 instanceof FlowerPotBlock var11
                    ...
                    return Pair.of(
                            (Predicate<ItemStack>)
                                    stack -> stack.getItem() instanceof BlockItem var3 && var3.getBlock() == var8,
                            null);
