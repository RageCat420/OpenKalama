...
public class MathUtils {
   ...
   public static Vec3d quadraticPolynomialFit(Vec3d[] positions, int ticksLater) {
      if (ticksLater <= 0 || positions.length < 3) {
         ...
         return new Vec3d(var13[0] * var11 + var13[1] * var9 + var13[2], var7[0] * var11 + var7[1] * var9 + var7[2], var8[0] * var11 + var8[1] * var9 + var8[2]);
      } else {
         return positions[2];
      }
   }
   ...
   public static Pair<Vec3d, Vec3d> D(double range, Vec3d point) {
      ...
      if (a(var5) <= var3) {
         ...
         return Pair.of(var13.add(var12.multiply(var10)).subtract(point), var13.subtract(var12.multiply(var10)).subtract(point));
      }
   }
   ...
   private static double[] solveQuadratic(double[] t, double[] p) {
      ...
      double var10 = p[1];
      double var12 = p[2];
      double var14 = var2 * var2 * (var4 - var6) + var2 * (var6 * var6 - var4 * var4) + (var4 * var4 * var6 - var4 * var6 * var6);
      double var16 = var8 * (var4 - var6) + var2 * (var12 - var10) + (var10 * var6 - var12 * var4);
      double var18 = var2 * var2 * (var10 - var12) + var8 * (var6 * var6 - var4 * var4) + (var4 * var4 * var12 - var6 * var6 * var10);
   ...
   public static Vec3d getVerticalWithSameY(Vec3d vec3d) {
      ...
      double var2 = var1.x;
      double var4 = var1.z;
      return Math.abs(var2) < 1.0E-8 && Math.abs(var4) < 1.0E-8 ? new Vec3d(1.0, 0.0, 0.0) : new Vec3d(var4, 0.0, -var2).normalize();
   }
   ...
   public static Vec3d getVerticalWithSameXZ(Vec3d vec3d) {
      Vec3d var1 = vec3d.normalize();
      return (var1.y != 0.0 ? new Vec3d(var1.x, -(a(var1.x) + a(var1.z)) / var1.y, var1.z) : new Vec3d(0.0, 1.0, 0.0)).normalize();
   }
