        ...
        if (player == null) {
            ...
            for (EquipmentSlot var6 : EquipmentSlot.values()) {
                ...
                if (var7 != null && !var7.isEmpty()) {
                    ItemEnchantmentsComponent var8 =
                            (ItemEnchantmentsComponent) var7.get(DataComponentTypes.ENCHANTMENTS);
                    if (var8 != null && !var8.isEmpty()) {
                        var2.e(
                                Enchantments.PROTECTION,
                                ItemStackUtils.getEnchantmentLevel(var8, Enchantments.PROTECTION));
                        var2.e(
                                Enchantments.BLAST_PROTECTION,
                                ItemStackUtils.getEnchantmentLevel(var8, Enchantments.BLAST_PROTECTION));
                        var2.e(
                                Enchantments.FIRE_PROTECTION,
                                ItemStackUtils.getEnchantmentLevel(var8, Enchantments.FIRE_PROTECTION));
                        var2.e(
                                Enchantments.PROJECTILE_PROTECTION,
                                ItemStackUtils.getEnchantmentLevel(var8, Enchantments.PROJECTILE_PROTECTION));
                        var2.e(
                                Enchantments.FEATHER_FALLING,
                                ItemStackUtils.getEnchantmentLevel(var8, Enchantments.FEATHER_FALLING));
                    }
                }
            }
