...
public class PlayerInputUtils$Input implements Cloneable {
    ...
    public PlayerInputUtils$Input rP(boolean jump) {
        return this.kV == jump
                ? this
                : new PlayerInputUtils$Input(this.kR, this.kS, this.kT, this.kU, jump, this.kW, this.kX);
    }
    ...
    public PlayerInputUtils$Input rR(boolean sprint) {
        return this.kX == sprint
                ? this
                : new PlayerInputUtils$Input(this.kR, this.kS, this.kT, this.kU, this.kV, this.kW, sprint);
    }
    ...
    public PlayerInputUtils$Input rM(boolean backward) {
        return this.kS == backward
                ? this
                : new PlayerInputUtils$Input(this.kR, backward, this.kT, this.kU, this.kV, this.kW, this.kX);
    }
    ...
    public PlayerInputUtils$Input sendPlayerInputAsRiding() {
        PlayerInputUtils.b
                .getNetworkHandler()
                .sendPacket(new PlayerInputC2SPacket(this.rp() * 0.98F, this.ro() * 0.98F, this.rI(), this.rJ()));
        return this;
    }
    ...
    public PlayerInputUtils$Input rL(boolean forward) {
        return this.kR == forward
                ? this
                : new PlayerInputUtils$Input(forward, this.kS, this.kT, this.kU, this.kV, this.kW, this.kX);
    }
    ...
    public PlayerInputUtils$Input sendPlayerSneakUpdatePacket() {
        if (this.kW) {
            PlayerInputUtils.b
                    .getNetworkHandler()
                    .sendPacket(new ClientCommandC2SPacket(PlayerInputUtils.b.player, Mode.PRESS_SHIFT_KEY));
        } else {
            PlayerInputUtils.b
                    .getNetworkHandler()
                    .sendPacket(new ClientCommandC2SPacket(PlayerInputUtils.b.player, Mode.RELEASE_SHIFT_KEY));
        }
    ...
    public PlayerInputUtils$Input rO(boolean right) {
        return this.kU == right
                ? this
                : new PlayerInputUtils$Input(this.kR, this.kS, this.kT, right, this.kV, this.kW, this.kX);
    }
    ...
    public PlayerInputUtils$Input rQ(boolean sneak) {
        return this.kW == sneak
                ? this
                : new PlayerInputUtils$Input(this.kR, this.kS, this.kT, this.kU, this.kV, sneak, this.kX);
    }
    ...
    public PlayerInputUtils$Input rN(boolean left) {
        return this.kT == left
                ? this
                : new PlayerInputUtils$Input(this.kR, this.kS, left, this.kU, this.kV, this.kW, this.kX);
    }
