...
public class PlayerInputUtils {
    ...
    public static final PlayerInputUtils$Input a =
            new PlayerInputUtils$Input(false, false, false, false, false, false, false);
    ...
    public static PlayerInputUtils$Input tryCorrectMovementInput(
            PlayerInputUtils$Input input, float originalYaw, float currentYaw) {
        ...
        if (var3 < 22.5 && var3 >= -22.5) {
            ...
            return new PlayerInputUtils$Input(
                    var6 > 0, var6 < 0, var7 > 0, var7 < 0, input.rI(), input.rJ(), input.rK());
        }
    }
