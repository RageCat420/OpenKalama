...
public final class CollisionUtil {
    ...
    public static boolean voxelShapeIntersect(
            Box box, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
    ...
    public static Vec3d performVoxelCollisions(
            Vec3d moveVector, Box axisalignedbb, List<VoxelShape> potentialCollisions) {
    ...
    public static double calculateAxisMin(MoonriseVoxelShapeAccess access, Axis axis) {
        ...
        switch (axis) {
            case X: {
                ...
                return var5 >= var2.sizeX()
                        ? Double.POSITIVE_INFINITY
                        : access.moonrise$rootCoordinatesX()[var5] + access.moonrise$offsetX();
            }
            case Y: {
                int var4 = var2.minFullY();
                return var4 >= var2.sizeY()
                        ? Double.POSITIVE_INFINITY
                        : access.moonrise$rootCoordinatesY()[var4] + access.moonrise$offsetY();
            }
            case Z: {
                int var3 = var2.minFullZ();
                return var3 >= var2.sizeZ()
                        ? Double.POSITIVE_INFINITY
                        : access.moonrise$rootCoordinatesZ()[var3] + access.moonrise$offsetZ();
            }
            default:
                    ...
                    if (var17 >= var13) {
                        ...
                        if (var17 >= var18) {
                            ...
                            if (var19 >= var14) {
                                ...
                                int var20 =
                                        Math.min(var14, findFloor(var10, aabb.maxZ - var6 - 1.0E-7, var19, var14) + 1);
                                if (var19 >= var20) {
                                    return false;
                                } else {
    ...
    public static Vec3d performCollisions(
            Vec3d moveVector, Box axisalignedbb, List<VoxelShape> voxels, List<Box> aabbs) {
        if (voxels.isEmpty()) {
    ...
    public static boolean getEntityHardCollisions(
            World world, Entity entity, Box aabb, List<Box> into, int collisionFlags, Predicate<Entity> predicate) {
        ...
        for (int var10 = var8.size(); var9 < var10; var9++) {
            ...
            if (!var11.isSpectator()
                    && (entity == null && var11.isCollidable() || entity != null && entity.collidesWith(var11))) {
                if (var6) {
                    return true;
                }
                                ...
                                for (int var35 = var31; var35 <= var32; var35++) {
                                    ...
                                    for (int var37 = var33; var37 <= var34; var37++) {
                                        ...
                                        for (int var39 = var29; var39 <= var30; var39++) {
                                            ...
                                            if (!var42.isAir()) {
                                                VoxelShape var43 = MoonriseBlockStateBaseAccess.of(var42)
                                                        .moonrise$getConstantCollisionShape();
                                                if (var43 == null) {
                                                    var19.set(var40, var36, var38);
                                                    var43 = var42.getCollisionShape(
                                                            world, var19, ShapeContext.absent());
                                                }
            ...
            for (Entity var4 : world.getOtherEntities(null, shape.getBoundingBox())) {
                if (!var4.isRemoved()
                        ...
                        && VoxelShapes.matchesAnywhere(
                                shape, VoxelShapes.cuboid(var4.getBoundingBox()), BooleanBiFunction.AND)) {
                    return true;
                }
            }
                        ...
                        for (int var31 = var21; var31 <= var22; var31++) {
                            ...
                            if (var32 >= 0 && var32 < var30.length) {
                                ...
                                if (var33 != null && !var33.isEmpty()) {
                                    boolean var34 = MoonriseChunkBlockCountingAccess.of(var33)
                                                    .getSpecialCollidingBlockCount()
                                            != 0;
                                    int var35 = !var34 ? 1 : 0;
                                                ...
                                                if (var50 != 3) {
                                                    ...
                                                    if (!var51.getBlock()
                                                            .getCollisionShape(
                                                                    ...
                                                                    ShapeContext.absent())
                                                            .isEmpty()) {
                                                        VoxelShape var55 = MoonriseBlockStateBaseAccess.of(var51)
                                                                .moonrise$getConstantCollisionShape();
                                                        if (var50 == 0
                                                                || (var50 != 1 || var51.exceedsCube())
                                                                        && (var50 != 2
                                                                                || var51.getBlock()
                                                            ...
                                                            Box var53 = MoonriseVoxelShapeAccess.of(var55)
