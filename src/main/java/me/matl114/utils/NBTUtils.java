...
public class NBTUtils {
   ...
   public static <W> void putValue(@Nonnull NbtCompound tag, String key, W value, Codec<W> codec, WrapperLookup lookup) {
      tag.put(key, (NbtElement)codec.encodeStart(lookup.getOps(NbtOps.INSTANCE), value).getOrThrow());
   }
   ...
   public static <W> W getValue(@Nonnull NbtCompound tag, String key, Codec<W> codec, WrapperLookup lookup) {
      ...
      return (W)(var4 == null ? null : codec.parse(lookup.getOps(NbtOps.INSTANCE), var4).resultOrPartial().orElse(null));
   }
   ...
   public static <W> W j(@Nonnull NbtCompound tag, String key, Codec<W> codec) {
      ...
      return (W)(var3 == null ? null : codec.parse(NbtOps.INSTANCE, var3).resultOrPartial().orElse(null));
   }
}
