...
public enum KalamaHelperHelperXX {
   qK(
      ...
      (world, pos) -> FarmingUtils.isAttachedFruitHarvestable(world, pos, Blocks.PUMPKIN, Blocks.ATTACHED_PUMPKIN_STEM)
   ),
   qO(
      Items.CACTUS,
      false,
   ...
   qS(
      ...
      (world, pos) -> {
         BlockState var2 = world.getBlockState(pos);
         return (var2.isOf(Blocks.CAVE_VINES) || var2.isOf(Blocks.CAVE_VINES_PLANT)) && (Boolean)var2.get(CaveVines.BERRIES);
      }
   ),
   qF(
      Items.POTATO,
   ...
   qM(Items.COCOA_BEANS, true, FarmingUtils.allStates(Blocks.COCOA), Set.of(Blocks.COCOA), FarmingUtils.o(Blocks.COCOA.getDefaultState()), (world, pos) -> {
      BlockState var2 = world.getBlockState(pos);
   ...
   qE(Items.CARROT, true, FarmingUtils.allStates(Blocks.CARROTS), Set.of(Blocks.CARROTS), FarmingUtils.o(Blocks.CARROTS.getDefaultState()), (world, pos) -> {
      BlockState var2 = world.getBlockState(pos);
   ...
   qD(Items.WHEAT_SEEDS, true, FarmingUtils.allStates(Blocks.WHEAT), Set.of(Blocks.WHEAT), FarmingUtils.o(Blocks.WHEAT.getDefaultState()), (world, pos) -> {
      BlockState var2 = world.getBlockState(pos);
   ...
   qJ(
      ...
      (world, pos) -> FarmingUtils.isAttachedFruitHarvestable(world, pos, Blocks.MELON, Blocks.ATTACHED_MELON_STEM)
   ),
   qI(
      Items.PITCHER_POD,
      true,
      ...
      FarmingUtils.o((BlockState)Blocks.PITCHER_CROP.getDefaultState().with(PitcherCropBlock.HALF, DoubleBlockHalf.LOWER)),
