...
public interface ItemStackData {
    ...
    ItemStack Ix = CustomItemStackBuilder.a()
            .type(Items.BARRIER)
            .amount(1)
            .e("&c物品解析失败")
            .g()
            ...
            .endLore()
            .build();
    Codec<ItemStackData> dt = Codec.PASSTHROUGH.xmap(
            dynamic -> {
                JsonElement var1 =
                        (JsonElement) dynamic.convert(JsonOps.INSTANCE).getValue();
    ...
    ItemStack Iy = CustomItemStackBuilder.a()
            .type(Items.STRUCTURE_VOID)
            .amount(1)
            .e("&c物品索引缺失")
            .g()
            .i("")
            .i("&7请修复item-database.json")
            .endLore()
            .build();
    ...
    public static ItemStack deserialize(JsonElement json) {
        if (json.isJsonObject()) {
            ...
            try {
                ItemStack var7 = (ItemStack) ((Pair) VItem.w()
                                .x()
                                .decode(ItemStackUtils.registry().getOps(JsonOps.INSTANCE), var6)
                                .getOrThrow())
                        .getFirst();
            ...
            try {
                ...
                ItemStack var3 = (ItemStack) ((Pair) VItem.w()
                                .x()
                                .decode(ItemStackUtils.registry().getOps(NbtOps.INSTANCE), var2)
                                .getOrThrow())
                        .getFirst();
