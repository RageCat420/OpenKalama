...
public class KalamaHelperHelperF implements GuiModel {
    ...
    public List<KalamaHelperHelperE> g(ItemRenderer renderer) {
        return this.guiModelList.stream()
                .flatMap(s ->
                        s instanceof KalamaHelperHelperF var2 ? var2.g(renderer).stream() : Stream.of(s.a(renderer)))
                .toList();
    }
    ...
    private List<KalamaHelperHelperE> h(List<KalamaHelperHelperE> originalEntries) {
        ...
        for (int var5 = 0; var5 < var3; var5++) {
            ...
            UnaryOperator<MatrixStack> var10 = var6.stackTransformer() != null
                    ? matrices -> var6.stackTransformer().apply(var9.apply(matrices))
                    : var9;
