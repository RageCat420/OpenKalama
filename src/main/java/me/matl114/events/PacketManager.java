...
public class PacketManager {
   ...
   public static void flushOutBound() {
      try {
         if (g.getNetworkHandler() != null && g.getNetworkHandler().getConnection().isOpen()) {
            f = true;
      ...
      if (e) {
         ...
         if (connection.getPacketListener() instanceof ClientPlayPacketListener var3) {
            if (!(packet instanceof DisconnectS2CPacket)
               ...
               Event var4 = new Event<>(new KalamaHelperHelperH(packet, System.currentTimeMillis(), connection), true, false, connection);
               j.b(var4);
               if (var4.d()) {
