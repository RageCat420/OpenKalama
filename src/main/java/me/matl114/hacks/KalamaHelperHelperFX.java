...
public class KalamaHelperHelperFX implements KalamaHelperHelperMX {
   ...
   public KalamaHelperHelperFX(Entity entity, Vec3d startPos, Vec3d endPos, boolean ignoreChunkBorder) {
      ...
      MovTasks.collectBoxInvolvingInMovements(entity, startPos, endPos.subtract(startPos), this.d, this.e, ignoreChunkBorder);
   ...
   @Override
   public List<Vec3d> generateTpSequence(Vec3d current, Vec3d target, boolean command, double farawayTp, boolean considerEnvironment) {
   ...
   public Vec3d simulateMovement(Entity entity, Vec3d currentPos, Vec3d currentTry) {
      ...
      RenderTasks.g = true;
      Vec3d var5 = MovTasks.collideWithTrustedList(var4.dimensions.getBoxAt(currentPos), currentTry, this.e, this.d, var4.getStepHeight(), var4.isOnGround());
      RenderTasks.g = false;
      return var5;
   }
