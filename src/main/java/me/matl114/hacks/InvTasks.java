...
public class InvTasks {
   ...
   public static ItemStack getHotbarStack(int hotbar) {
      return hotbar == 40 ? (ItemStack)a.player.getInventory().offHand.get(0) : (ItemStack)a.player.getInventory().main.get(hotbar);
   }
      ...
      if (getCurrentServerScreen(a.player) instanceof HandledScreen var1) {
         ...
         for (int var3 = 0; var3 < var2.slots.size(); var3++) {
            ...
            if (var4.inventory instanceof PlayerInventory) {
               int var5 = var3;
               E.execute(() -> a.interactionManager.clickSlot(var2.syncId, var5, 1, SlotActionType.QUICK_MOVE, a.player));
            }
         }
      }
   }
   ...
   public static void creativeGive(ItemStack itemStack, int count) {
      if (a.player != null && a.interactionManager != null && a.interactionManager.getCurrentGameMode().isCreative()) {
         ...
         for (int var7 : b) {
            ...
            } else if (var8.getStack().getCount() < var3 && ItemStack.areItemsAndComponentsEqual(var8.getStack(), itemStack)) {
   ...
   public static boolean dropAllCursorStack() {
      ...
      if (var0 == null) {
         ...
         if (var1.getCursorStack() != null && !var1.getCursorStack().isEmpty()) {
            ...
            at().execute(() -> MinecraftClient.getInstance().interactionManager.clickSlot(var1.syncId, -999, 0, SlotActionType.PICKUP, var0));
            ...
            for (int var3 = 0; var3 < var1.slots.size(); var3++) {
               ...
               if (ItemStack.areItemsEqual(var4, var2)) {
                  ...
                  if (ItemStack.areItemsAndComponentsEqual(var5, var2)) {
                     int var6 = var3;
                     at().execute(() -> MinecraftClient.getInstance().interactionManager.clickSlot(var1.syncId, var6, 1, SlotActionType.THROW, var0));
                  }
               }
            }
   ...
   public static boolean quickDropSlotItem(HandledScreen handled, Slot slot) {
      if (slot != null && slot.getStack() != null && slot.getStack().getItem() != Items.AIR) {
         ...
         for (int var4 = 0; var4 < var3.slots.size(); var4++) {
            ...
            if (ItemStack.areItemsEqual(var2, var5.getStack()) && ItemStack.areItemsAndComponentsEqual(var2, ItemStackUtils.I(var5.getStack(), false, false))) {
               int var6 = var4;
               E.execute(() -> a.interactionManager.clickSlot(var3.syncId, var6, 1, SlotActionType.THROW, a.player));
            }
         }
   ...
   public static void moveStackToSlotRanged(
      ScreenHandler handledScreen, ItemStack itemStack, int toSlot, int toAmountAdd, boolean removeExist, int fromRange, int toRange
   ) {
   ...
   public static KalamaHelperHelperB getItemStackMatchingSlot(ScreenHandler screen, ItemStack stack, int... list) {
      if (stack.isEmpty()) {
         ...
         for (int var8 : list) {
            ...
            if (var9 != null && !var9.getStack().isEmpty() && ItemStack.areItemsAndComponentsEqual(var9.getStack(), stack)) {
   ...
   public static void moveStackToSlot(
      ScreenHandler handledScreen, ItemStack itemStack, int toSlot, int toAmountAdd, boolean removeExist, int... trustedSlotIndexList
   ) {
      if (!itemStack.isEmpty()) {
         ...
         if (isScreenHandlerValid(handledScreen)) {
            ...
            if (!var7.isEmpty()) {
               if (ItemStack.areItemsAndComponentsEqual(var7, itemStack)) {
                  ...
                  a.interactionManager.clickSlot(handledScreen.syncId, toSlot, 1, SlotActionType.QUICK_MOVE, a.player);
                  if (!handledScreen.getSlot(toSlot).getStack().isEmpty()) {
                     a.interactionManager.clickSlot(handledScreen.syncId, toSlot, 1, SlotActionType.THROW, a.player);
                  }
               }
            }
            ...
            if (var8 >= itemStack.getMaxCount()) {
               ...
               for (int var12 : trustedSlotIndexList) {
                  if (!var6.getSlot(var12).getStack().isEmpty() && ItemStack.areItemsAndComponentsEqual(var6.getSlot(var12).getStack(), itemStack)) {
               ...
               for (int var18 : trustedSlotIndexList) {
                  if (!var6.getSlot(var18).getStack().isEmpty() && ItemStack.areItemsAndComponentsEqual(var6.getSlot(var18).getStack(), itemStack)) {
   ...
   public static void creativeAddItem(ItemStack itemStack, int count) {
      if (a.player != null && a.interactionManager != null && a.interactionManager.getCurrentGameMode().isCreative()) {
         ...
         for (int var9 : b) {
            ...
            if (var10.getStack().getCount() < var4 && ItemStack.areItemsAndComponentsEqual(var10.getStack(), itemStack)) {
               var2 = var9;
   ...
   public static void executePredictInventoryAction(Inventory topInventory, Consumer<ScreenHandler> callback) {
      ...
      GenericContainerScreenHandler var3 = new GenericContainerScreenHandler(
         ScreenUtils.getGenericScreenType(topInventory.size()), var2, a.player.getInventory(), topInventory, (topInventory.size() - 1) / 9 + 1
      );
      ...
      if (slot != null) {
         ...
         for (int var5 = 0; var5 < var2.slots.size(); var5++) {
            ...
            if (var6.inventory instanceof PlayerInventory == var4
               ...
               && ItemStack.areItemsAndComponentsEqual(var3, ItemStackUtils.I(var6.getStack(), false, false))) {
   ...
   public static void k(ScreenHandler handler, int index, boolean ignoreConfig) {
      if (!ignoreConfig && handler.getSlot(index).getStack().getCount() > 1 && ag().leftOne.get()) {
         int var3 = handler.syncId;
         if (!handler.getCursorStack().isEmpty()) {
            Debug.b(Text.literal("[left 1] ").formatted(Formatting.RED).append(Text.literal("cursor stack needs to be empty to apply left-one quickMove")));
            return;
         }
            ...
            if (var8.inventory instanceof PlayerInventory != var5
               && (
                  var8.getStack().isEmpty()
                     || var8.getStack().getCount() < var8.getStack().getMaxCount() && ItemStack.areItemsAndComponentsEqual(var4.getStack(), var8.getStack())
               )) {
               var6 = true;
               break;
            }
            ...
            if (var9.inventory instanceof PlayerInventory != var5
               && (
                  var9.getStack().isEmpty()
                     || var9.getStack().getCount() < var9.getStack().getMaxCount() && ItemStack.areItemsAndComponentsEqual(var4.getStack(), var9.getStack())
               )) {
   ...
   public static KalamaHelperHelperB allSlotMatch(HandledScreen handledScreen) {
      KalamaHelperHelperB var1 = new KalamaHelperHelperB();
      int[] var2 = IntStream.range(0, handledScreen.getScreenHandler().slots.size()).toArray();
   ...
   @Modifiable
   public static void G(ScreenHandler screen, ItemStack[] ingredients, int[] slot, int patternAmount, boolean removeOrigin) {
      int[] var5 = getPlayerInventorySlots(screen).toIntArray();
      moveRecipePatternToContainer(
         screen, ingredients, slot, patternAmount, removeOrigin, (screen1, itemStack) -> getItemStackMatchingSlot(screen1, itemStack, var5)
      );
   }
   ...
   public static int predictOpenVanillaContainerSize(BlockPos blockPos) {
      if (a.world.getBlockEntity(blockPos) instanceof Inventory var2) {
         ...
         if (var2 instanceof ChestBlockEntity var3) {
            ...
            if (var4.getBlock() instanceof ChestBlock var6) {
               if (ChestBlock.isChestBlocked(a.world, blockPos)) {
                  var7 = 0;
               } else if (ChestBlock.getDoubleBlockType(var4) != net.minecraft.block.DoubleBlockProperties.Type.SINGLE) {
                  var7 = 54;
               }
            }
         }
         ...
         if (var2 instanceof ShulkerBoxBlockEntity var8) {
            ...
            if (var8.getAnimationStage() == AnimationStage.CLOSED && !InteractUtils.canShulkerOpen(a.world, blockPos, var9)) {
               var7 = 0;
            }
         }
