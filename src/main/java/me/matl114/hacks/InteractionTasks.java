...
public class InteractionTasks {
    ...
    public static void i(
        ...
        switch (mode) {
            case USEITEM_PACKET:
                Vec2f var12 = EntityUtils.q(
                        targetCenter.subtract(a.player.getEyePos()).normalize());
                int var15 = -1;
                ...
                for (Pair var21 : resultList) {
                    ...
                    if (var15 == -1) {
                        ...
                        a.interactionManager.sendSequencedPacket(
                                a.world, i -> new PlayerInteractItemC2SPacket(Hand.MAIN_HAND, i, var12.y, var12.x));
                    } else {
                        h();
                    }
            ...
            case LEGACY_SLIENT_ROT:
                ...
                for (Pair var16 : resultList) {
                    ...
                    LegacySnapRotManager.INSTANCE.ahs(
                            var8.getBlockPos()
                                    .toCenterPos()
                                    .subtract(a.player.getEyePos())
                                    .normalize(),
                            false);
    ...
    public static List<FlagEntry<BlockHitResult>> p(
        ...
        for (Direction var11 : new Direction[] {
    ...
    public static void g(Configs$LegalInteractMode mode, BlockHitResult result, Hand hand, boolean swingHand) {
        ...
        switch (mode) {
            case USEITEM_PACKET:
                ...
                a.interactionManager.sendSequencedPacket(
                        a.world, i -> new PlayerInteractItemC2SPacket(hand, i, var8.y, var8.x));
            ...
            case MOVEMENT_POST:
                ...
                Listener.B(new PacketCatcherImpl<>(
                        PlayerInteractBlockC2SPacket.class, (Event<PlayerInteractBlockC2SPacket> eve) -> {
                            if (eve.d()) {
                                return true;
                            } else {
                                var7.setValue(eve.b);
                ...
                if (var7.getValue() != null) {
                    ...
                    d(result.getBlockPos().toCenterPos(), var4, () -> a.getNetworkHandler()
                            .sendPacket(var6));
                }
                break;
            case LEGACY_SLIENT_ROT:
    ...
    private static FlagEntry<BlockHitResult> s(
        ...
        if (currentState != null && targetState != null && !currentState.isAir() && !currentState.isLiquid()) {
            ...
            for (Direction var21 : var6) {
                ...
                ItemPlacementContext var14 = new ItemPlacementContext(
                        a.player,
                        Hand.MAIN_HAND,
                ...
                if (var14.canReplaceExisting() && (var19 || enablePositionPlace || !k(placeTargetBlock, var21, var5))) {
                    ...
                    BlockState var15 =
                            InteractUtils.getBlockPlacement(targetState.getBlock(), a.player, a.world, var13);
    ...
    public static FlagEntry<BlockHitResult> o(
        ...
        for (Direction var10 : new Direction[] {
            Direction.DOWN, Direction.UP, Direction.NORTH, Direction.SOUTH, Direction.WEST, Direction.EAST
        }) {
            if (var10 != var5) {
                var6.add(var10);
            ...
            for (Direction var22 : var6) {
                ...
                if (!var14.isAir() && !var14.isLiquid()) {
                    ...
                    if (j(var13, playerPos)) {
                        FlagEntry var23 =
                                new FlagEntry<>(var15, new BlockHitResult(var11, var22.getOpposite(), var13, true));
                        if (!var23.flag()) {
                            return var23;
                        }
                        ...
                        FlagEntry var16 =
                                new FlagEntry<>(var15, new BlockHitResult(var11, var22.getOpposite(), var13, false));
                        if (!var16.flag()) {
                            return var16;
                        }
    ...
    public static FlagEntry<BlockHitResult> q(
        ...
        if (var12 != null && var5 == var12.flag()) {
            ...
            if (var7 instanceof StairsBlock) {
                ...
                for (Direction var15 : var11) {
                    ...
                    Vec3d var19 = var15 != Direction.DOWN && var15 != Direction.UP
                            ? var16.add(0.0, 0.25 * (var13 == BlockHalf.TOP ? 1 : -1), 0.0)
                            : var16;
                    if (enableAirPlace) {
                        return new FlagEntry<>(
                                false, new BlockHitResult(var19, var15.getOpposite(), placeTargetBlock, false));
                    }
                    ...
                    if (!var20.isAir() && !var20.isLiquid()) {
                        ...
                        if (j(var18, var10)) {
                            FlagEntry var86 =
                                    new FlagEntry<>(var21, new BlockHitResult(var19, var15.getOpposite(), var18, true));
                            if (var5 == var86.flag()) {
                                return var86;
                            }
                            ...
                            FlagEntry var22 = new FlagEntry<>(
                                    var21, new BlockHitResult(var19, var15.getOpposite(), var18, false));
                            if (var5 == var22.flag()) {
                                return var22;
                            }
                ...
                for (Direction var53 : var11) {
                    ...
                    if (!var76.isOf(targetState.getBlock())
                        ...
                        Vec3d var81 = var53 != Direction.DOWN && var53 != Direction.UP
                                ? var59.add(0.0, 0.25 * var31, 0.0)
                                : var59;
                        if (enableAirPlace) {
                            return new FlagEntry<>(
                                    false, new BlockHitResult(var81, var53.getOpposite(), placeTargetBlock, false));
                        }

                        if (!var76.isAir() && !var76.isLiquid()) {
                            boolean var87 = InteractUtils.s(a.world, a.player, var71, var76);
                            if (j(var71, var10)) {
                                FlagEntry var94 = new FlagEntry<>(
                                        var87, new BlockHitResult(var81, var53.getOpposite(), var71, true));
                                if (var5 == var94.flag()) {
                                    return var94;
                                }
                                ...
                                FlagEntry var23 = new FlagEntry<>(
                                        var87, new BlockHitResult(var81, var53.getOpposite(), var71, false));
                                if (var5 == var23.flag()) {
                                    return var23;
                                }
                ...
                for (Direction var44 : var11) {
                    if (!var44.getAxis().isHorizontal()
                            || targetState.get(TrapdoorBlock.FACING) == var44.getOpposite()) {
                        ...
                        if (enableAirPlace) {
                            return new FlagEntry<>(
                                    false, new BlockHitResult(var77, var44.getOpposite(), placeTargetBlock, false));
                        }

                        if (!var72.isAir() && !var72.isLiquid()) {
                            boolean var82 = InteractUtils.s(a.world, a.player, var66, var72);
                            if (j(var66, var10)) {
                                FlagEntry var89 = new FlagEntry<>(
                                        var82, new BlockHitResult(var77, var44.getOpposite(), var66, true));
                                if (var5 == var89.flag()) {
                                    return var89;
                                }
                                ...
                                FlagEntry var88 = new FlagEntry<>(
                                        var82, new BlockHitResult(var77, var44.getOpposite(), var66, false));
                                if (var5 == var88.flag()) {
                                    return var88;
                                }
                ...
                if (var7 instanceof EndRodBlock) {
                    ...
                    if (a.player.shouldCancelInteraction()) {
                                ...
                                if (!side.getAxis().isHorizontal()) {
                                    ...
                                    if (!(var6x.getBlock() instanceof ChestBlock)) {
                                        ...
                                        if (var7x.getAxis() == side.getAxis()) {
                                            ...
                                            ChestType var8x = var7x.rotateYCounterclockwise() == side.getOpposite()
                                                    ? ChestType.RIGHT
                                                    : ChestType.LEFT;
                        ...
                        for (BlockPos var95 :
                                new BlockPos[] {placeTargetBlock.offset(var61), placeTargetBlock.offset(var67)}) {
                ...
                for (Direction var69 : new Direction[] {
                    Direction.DOWN, Direction.UP, Direction.NORTH, Direction.SOUTH, Direction.WEST, Direction.EAST
                }) {
                ...
                if (enableAirPlace) {
                    ...
                    return new FlagEntry<>(
                            var30, new BlockHitResult(var58, var52.getOpposite(), placeTargetBlock, false));
                }
                ...
                for (Direction var57 : var11) {
                    ...
                    if (!var80.isAir() && !var80.isLiquid()) {
                        ...
                        if (j(var75, var10)) {
                            FlagEntry var93 = new FlagEntry<>(
                                    var85 || var30, new BlockHitResult(var64, var57.getOpposite(), var75, true));
                            if (var5 == var93.flag()) {
                                return var93;
                            }
                            ...
                            FlagEntry var92 = new FlagEntry<>(
                                    var85 || var30, new BlockHitResult(var64, var57.getOpposite(), var75, false));
                            if (var5 == var92.flag()) {
                                return var92;
                            }
    ...
    public static void c(PlayerEntity player, Entity entity, Hand hand, boolean swing) {
        ActionResult var4 = a.interactionManager.interactEntityAtLocation(
                a.player, entity, RaycastUtils.createRealHitResult(entity, player.getEyePos()), hand);
        if (!var4.isAccepted()) {
    ...
    public static FlagEntry<BlockHitResult> m(
    ...
    public static FlagEntry<Vec2f> u(Vec3d eyePos, BlockPos pos, BlockState targetState) {
        if (a.world != null && a.player != null) {
            ...
            for (Direction var12 : new Direction[] {
                Direction.DOWN, Direction.UP, Direction.NORTH, Direction.SOUTH, Direction.WEST, Direction.EAST
            }) {
                if (var12 != var7) {
                    var8.add(var12);
            ...
            while (true) {
                ...
                if (!(new Vec3d(var29.getX(), var29.getY(), var29.getZ()).dotProduct(var30) > 0.0)
                        && !var15.isAir()
                        && !var15.isLiquid()) {
                    for (Vec3d var19 : v(var28, var15, var13)) {
                        ...
                        if (!(var20.lengthSquared() < 1.0E-12) && !(var20.lengthSquared() > var5 * var5)) {
                            ...
                            BlockHitResult var23 = a.world.raycast(new RaycastContext(
                                    eyePos,
                                    eyePos.add(var22.multiply(var5)),
                                    ShapeType.OUTLINE,
                                    FluidHandling.NONE,
                                    a.player));
                            if (var23.getType() == Type.BLOCK
                                    && var23.getBlockPos().equals(var28)
                                    && var23.getSide() == var13) {
    ...
    public static Entity z(Predicate<Entity> targetBlock) {
        int var1 = Tasks.b();
        return var1 < c + 20 && b != null && b.isAlive() && targetBlock.test(b)
                ? b
                : RaycastUtils.rayTraceSpecificEntity(targetBlock).orElse(null);
    }
    ...
    public static FlagEntry<BlockHitResult> n(
