...
public class SkinBlink extends BaseModule {
    ...
    public SkinBlink() {
        ...
        this.switchModel = this.builder(this.iE.add("switch-model"), Boolean.class)
                .defaultValue(true)
                .build();
        this.switchModelParts = this.builder(
                        this.iE.add("switch-model-parts"), SkinBlink$PlayerModelPartSelectSet.class)
