...
public class EnderEyeLog extends BaseModule {
   ...
   public final FlagRef ae = this.flagBuilder(this.ad.add("enable-ender-eye-log")).build();
               ...
               CompletableFuture.<IntList>supplyAsync(() -> {
                  ...
                  if (!i.isEmpty()) {
                     ...
                     while (var14.hasNext()) {
                        ...
                        for (byte var10 = 0; var10 < STRONGHOLD_DISTANCE_RANGES.size() - 1; var10 += 2) {
                           ...
                           if (var9x >= var11x && var9x <= var12) {
                              ...
                              var13 = var10;
                              Debug.chat("[EnderEye] Most probably at:", ChatUtils.s(var15, var8), ",In ring", var10 / 2 + 1);
                           }
                        }
                     }
                  } else {
