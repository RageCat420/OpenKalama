...
class ExtraSubHelperO extends GenericScreen {
    ...
    ExtraSubHelperO(
            final ServerScanner this$0,
            Text title,
            int backgroundWidth,
            int backgroundDefaultHeight,
            final DrawableWidget param5,
            final DrawableWidget nullx) {
    ...
    protected void init() {
        ...
        var1.Q(me.matl114.gui.basic.DisplayWidget.instance(0, 0, 400, 20)
                .setRenderHandler(me.matl114.gui.elements.LabelElement.instance(this.dT)));
        var1.Q(this.dW);
        var1.Q(this.dV.wv);
        var1.Q(this.dU);
