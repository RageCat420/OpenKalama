...
public class ServerScanner extends BaseModule {
    ...
    public DrawableWidget createInputWidget() {
        ...
        var1.Q(new KalamaHelperHelperE<>(320, 20, 40, 20, 20, this.wm.createKeyValue("R"))
                .eJ(List.of(Text.literal("Random"))));
        var1.Q(new KalamaHelperHelperE<>(360, 20, 40, 20, 20, this.wn.createKeyValue("F"))
                .eJ(List.of(Text.literal("Filter"))));
        var1.Q(ExecutableWidget.instance(200, 0, 40, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Scan")), ButtonAction.a(this::Hj))));
        var1.Q(ExecutableWidget.instance(240, 0, 40, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Stop")), ButtonAction.a(this::Hl))));
        var1.Q(ExecutableWidget.instance(280, 0, 40, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("AScan")), ButtonAction.a(this::Hk))));
    ...
    private ElementHandler HE(@Nonnull ServerInfo serverInfo) {
        return new ExtraSubHelperM(this, null, null, false, ButtonAction.a(() -> this.connect(serverInfo)), serverInfo)
                .setActive(false);
    }
    ...
    public DrawableWidget createOutputWidget() {
        ...
        var1.Q(DisplayWidget.instance(0, 10, 80, 20)
                .setRenderHandler(new ButtonElement(TextProvider.c(Text.literal("Add Server")), ButtonAction.c())));
        ContentDelegateWidget var2 =
                McWidgetHelpers.c(80, 10, 100, 20, PropertyTracker.event(s -> this.ws = s), this.ws);
        var1.Q(var2);
        var1.Q(ExecutableWidget.instance(180, 10, 20, 20)
                .eV(new ButtonElement(
                                TextProvider.c(Text.literal("+").formatted(Formatting.BOLD)), ButtonAction.a(() -> {
                                    if (!this.ws.isEmpty()) {
                                        this.Hq(this.ws);
        ...
        var1.Q(ExecutableWidget.instance(200, 10, 100, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Refresh All")), ButtonAction.a(this::Ho))));
        var1.Q(ExecutableWidget.instance(300, 10, 100, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Copy Server List")), ButtonAction.a(() -> {
                    ...
                    mc.keyboard.setClipboard(
                            new GsonBuilder().disableHtmlEscaping().create().toJson(var1x));
                    this.logInfo("已拷贝IP列表");
                }))));
        var1.Q(ExecutableWidget.instance(0, 30, 80, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Remove Server")), ButtonAction.c())));
        ContentDelegateWidget var3 =
                McWidgetHelpers.c(80, 30, 100, 20, PropertyTracker.event(s -> this.wt = s), this.wt);
        var1.Q(var3);
        var1.Q(ExecutableWidget.instance(180, 30, 20, 20)
                .eV(new ButtonElement(
                                TextProvider.c(Text.literal("-").formatted(Formatting.BOLD)), ButtonAction.a(() -> {
                                    if (!this.wt.isEmpty()) {
        ...
        var1.Q(ExecutableWidget.instance(200, 30, 100, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Refresh Shown")), ButtonAction.a(() -> {
        ...
        var1.Q(ExecutableWidget.instance(300, 30, 100, 20)
                .eV(new ButtonElement(TextProvider.c(Text.literal("Back")), ButtonAction.a(() -> {
            ...
            if (var1 > var2) {
                ...
                CompletableFuture.runAsync(() -> {
                    ...
                    try (ThreadPoolExecutor var10 = (ThreadPoolExecutor) Executors.newFixedThreadPool(16)) {
                        ...
                        CompletableFuture.allOf(var11.toArray(new CompletableFuture[var11.size()]))
                                .join();
                        this.logInfo("异步扫描结束");
                    }
    ...
    public void onButtonAddWhenInitialize(Event<MultiplayerScreen> screenEvent) {
        if (this.ae.get()) {
            ...
            ExecutableWidget var4 = ExecutableWidget.instance(0, 0, 50, 20)
                    .eV(new ButtonElement(
                            TextProvider.c(Text.literal("Scanner")), ButtonAction.a(this::openScannerScreen)));
    ...
    private Text getServerMotd(ServerInfo serverInfo) {
        return (Text)
                (serverInfo.getStatus() != Status.UNREACHABLE && serverInfo.label != null
                        ? serverInfo.label
                        : Text.empty());
    }
    ...
    public ServerScanner() {
        super("ServerScanner");
        this.ae = this.builder(this.wf.addEnable(), FlagRef.TYPE)
                .defaultValue(true)
                .build();
    ...
    private Text getPlayerListDisplay(ServerInfo serverInfo) {
        if (serverInfo.getStatus() == Status.UNREACHABLE) {
            ...
            return serverInfo.players == null
                    ? Text.literal("加载中...")
                    : Text.literal(serverInfo.players.online() + "/" + serverInfo.players.max())
    ...
    private ElementHandler HF(ServerInfo serverInfo) {
        ...
        return new IconElement$SimpleIconElement(null, null, true, (el1, el2, el3) -> {
                ...
                .cs((el, h) -> ((DrawableWidget) el).isFocused() ? -1 : null)
    ...
    public DrawableWidget createJoinServerWidget(String ip) {
        ...
        var2.Q(DisplayWidget.instance(0, 0, 310, 40)
                .setRenderHandler(new AbstractElement()
                        ...
                        .cD((element, context, mouseX, mouseY, delta, alpha, shouldHighlight) -> {
                            ...
                            if (element.isMouseOver(mouseX, mouseY)) {
                                RenderHandler.K(
                                        context, 0, 0, element.getTextureWidth(), element.getTextureHeight(), -1);
                            }
                        })));
        var2.Q(ExecutableWidget.instance(45, 0, 100, 9)
                .eV(RawTextElement.g(Text.literal(ip))
                        .setAlignment(-1)
                        .cF(new ButtonElement(TextProvider.c(Text.empty()), ButtonAction.a(() -> {
        ...
        if (var4 != null) {
            ...
            var2.Q(DisplayWidget.instance(260, 0, 50, 40)
                    .setRenderHandler(TooltipHandler.ar(() -> this.getServerInfoHover(var4))));
            var2.Q(DisplayWidget.instance(260, 8, 50, 9)
                    .setRenderHandler(RawTextElement.h(b -> this.getStatusDisplay(var4.getStatus()))
                            .setAlignment(1)));
            var2.Q(DisplayWidget.instance(260, 16, 50, 9)
                    .setRenderHandler(RawTextElement.h(b -> this.getPlayerListDisplay(var4))
                            .setAlignment(1)));
            var2.Q(DisplayWidget.instance(260, 24, 50, 9)
                    .setRenderHandler(RawTextElement.h(b -> this.getServerBrandInfoDisplay(var4))
                            .setAlignment(1)));
            var2.Q(DisplayWidget.instance(50, 10, 270, 30)
                    .setRenderHandler(new MultiLineTextElement(s -> this.getServerMotd(var4), -1, -1)));
        } else {
