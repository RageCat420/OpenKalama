...
public class PacketDebug extends BaseModule {
    ...
    public PacketDebug() {
        ...
        this.AX = this.toggleHotkey(this.AU.addHotkey(), new MultiKeyBind(), this.AU.addEnable())
                .build();
        ...
        this.stopDebugInChat = this.flagBuilder(this.AU.add("stop-debug-in-chat"))
