...
public class SkinBlink$PlayerModelPartSelectSet extends BoundedPrimitiveFlagMap<PlayerModelPart>
        implements NBTParsable<SkinBlink$PlayerModelPartSelectSet> {
    public static final NBTType<SkinBlink$PlayerModelPartSelectSet> TYPE = createEnumMap(
            ...
            SkinBlink$PlayerModelPartSelectSet::new);
