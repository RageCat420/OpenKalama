...
public class GuiFix extends BaseModule {
   ...
   public final FlagRef zn = this.flagBuilder(this.zm.add("disable-terrain-load-screen")).build();
   public final FlagRef zo = this.builder(this.zm.add("optimize-game-menu"), FlagRef.TYPE).defaultValue(true).build();
   ...
   public GuiFix() {
      super("GuiFix");
      this.optimizeServerScreen = this.builder(this.zm.add("optimize-server-screen"), FlagRef.TYPE).defaultValue(true).build();
   }
   ...
   public void registerAll() {
      ...
      this.registerListener(Listener.ai().c(GameMenuScreen.class), this::onGameMenuScreenRelocateWurstButton, 2147483646);
      this.registerListener(Listener.ai().c(MultiplayerScreen.class), this::onServerListMenuRelocateButtons, 2147483646);
   }
