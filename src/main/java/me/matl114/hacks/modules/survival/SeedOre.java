...
public class SeedOre extends BaseModule {
    ...
    private static ArrayList<Vec3d> generateHidden(ClientWorld world, ChunkRandom random, BlockPos blockPos, int size) {
        ...
        for (int var6 = 0; var6 < var5; var6++) {
            ...
            if (world.getBlockState(new BlockPos(var7, var8, var9)).isOpaque()
                    && shouldPlace(world, new BlockPos(var7, var8, var9), 1.0F, random)) {
    ...
    public SeedOre() {
        ...
        this.chunkRadius = this.builder(this.Eq.add("chunk-radius"), IntRef.TYPE)
                .defaultValue(6)
                .validator(Configs.e)
                .build();
        this.renderOre = this.flagBuilder(this.Eq.add("render-ore")).build();
        this.fakeOre = false;
        this.enableFakeOre = this.flagBuilder(this.Eq.add("enable-fake-ore"))
                .defaultValue(false)
                    ...
                    ChunkPos.stream(var2, 1).forEach(chunkPosx -> {
                        ...
                        if (var3x != null) {
                            for (ChunkSection var7x : var3x.getSectionArray()) {
                                var7x.getBiomeContainer()
                                        .forEachValue(
                                                entry -> var7.add(entry.getKey().get()));
                            }
                        }
                    });
                    Set<SurvivalSubHelperC> var8 = var7.stream()
                            .flatMap(b -> this.getDefaultOres(b).stream())
                    ...
                    for (SurvivalSubHelperC var15 : var8) {
                        ...
                        for (int var18 = 0; var18 < var17; var18++) {
                            if (var15.u == 1.0F || !(var11.nextFloat() >= 1.0F / var15.u)) {
                                ...
                                RegistryKey var23 = (RegistryKey) chunk.getBiomeForNoiseGen(var19, var21, var20)
                                        .getKey()
                                        .get();
                                ...
                                for (int var57 = var47; var57 <= var50; var57++) {
                                    ...
                                    if (var52 * var52 + var55 * var55 + var58 * var58 < 1.0) {
                                        ...
                                        if (!var21.get(var60)) {
                                            ...
                                            if (var54 >= -64
                                                    && var54 < 320
                                                    && world.getBlockState(var22)
                                                            .isOpaque()
                                                    && shouldPlace(world, var22, discardOnAir, random)) {
    ...
    public boolean checkCurrentSeedExistence() {
        if (this.hasCurrentSeed()) {
            ...
            Debug.b(Text.literal("[世界种子] 暂时没有设置 %s 世界的种子".formatted(CommonUtils.getWorldName()))
    ...
    public void onReloadSeedOre() {
        try {
            ...
            if (mc.player != null && mc.world != null) {
                Debug.b(Text.literal("[种子矿透] 启用该功能, 范围 %d".formatted(this.chunkRadius.get()))
    ...
    private List<SurvivalSubHelperC> getDefaultOres(RegistryKey<Biome> biomeRegistryKey) {
        return this.Ex.containsKey(biomeRegistryKey)
                ? this.Ex.get(biomeRegistryKey)
                : this.Ex.values().stream().findAny().get();
    }
    ...
    public void onSeedList() {
        ...
        while (var1.hasNext()) {
            it.unimi.dsi.fastutil.objects.Object2LongMap.Entry var2 =
                    (it.unimi.dsi.fastutil.objects.Object2LongMap.Entry) var1.next();
    ...
    public void validateCurrentSeed() {
        if (this.checkCurrentSeedExistence()) {
            ...
            Debug.b(Text.literal("[世界种子] 输入的种子: ")
                    .formatted(Formatting.GREEN)
                    .append(ChatUtils.getDisplayedLong(var1)));
