...
public class SurvivalSubHelperC {
   ...
   public static final List<AttrKeyValue<Boolean>> l = new ArrayList<>(
      Arrays.asList(a, SurvivalSubHelperC.b, c, SurvivalSubHelperC.d, SurvivalSubHelperC.e, SurvivalSubHelperC.f, g, h, SurvivalSubHelperC.i, j)
   );
   ...
   private SurvivalSubHelperC(PlacedFeature feature, Block block, Block deepslate, int step, int index, AttrKeyValue<Boolean> active, Color color) {
      this.u = 1.0F;
      this.m = step;
      this.n = index;
      this.q = active;
