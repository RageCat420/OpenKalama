...
public class SurvivalSubHelperI {
   ...
   public static final Codec<SurvivalSubHelperI> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            Registries.BLOCK_ENTITY_TYPE.getCodec().fieldOf("block-type").forGetter(SurvivalSubHelperI::f),
