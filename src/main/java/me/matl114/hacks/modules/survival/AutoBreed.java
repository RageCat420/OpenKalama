...
public class AutoBreed extends BaseModule {
    ...
    public void tickBreed() {
        if (this.Rd != null
                && !this.aL.y()
                && TargetSelector.INSTANCE.isWithinAttackRange(mc.player.getPos(), this.Rd)) {
    ...
    private void refreshTarget() {
        if (this.Rd != null && this.isBreedTarget(this.Rd)) {
            ...
            this.Rd = null;
            this.Re = null;
            List<AnimalEntity> var1 = mc.world.getEntitiesByClass(
                    AnimalEntity.class, mc.player.getBoundingBox().expand(32.0, 16.0, 32.0), this::isBreedTarget);
            AnimalEntity var2 = var1.stream()
                    .min(Comparator.comparingDouble(animal -> animal.squaredDistanceTo(mc.player)))
                    .orElse(null);
            if (var2 != null) {
            ...
            if (var3 != null && var4 != null && var5 != null && var6 != null) {
                ...
                if (var8 > var7 && var10 > var9) {
                    ...
                    if (var11 * var12 <= 256 && (var11 <= 16 || var12 <= 16)) {
                        return !this.isRectangularPen(var7, var8, var9, var10, var2.getY())
                                ? null
                                : new SurvivalSubHelperF(var7, var8, var9, var10, var2.getY());
                    } else {
                        return null;
                    }
                } else {
    ...
    public AutoBreed() {
        ...
        this.babyFeedLimit = this.builder(this.aD.add("baby-feed-limit"), Integer.class)
                .defaultValue(3)
                .build();
        ...
        this.renderColor = this.builder(this.aD.add("render-color"), WrapColor.class)
                ...
                .build();
        this.renderPenColor = this.builder(this.aD.add("render-pen-color"), WrapColor.class)
        ...
        this.aL
                ...
                .G(this::ahX)
                .K((pos, inventory) ->
                        this.Rd != null && InventoryUtils.findItem(inventory, this.ahT(this.Rd), false) != null)
                .E(this::processGoal);
    ...
    public void onRender(Event<MatrixStack> event) {
        if (this.ae.get() && this.render.get() && this.Rd != null) {
            ...
            try {
                ...
                var3.submit(
                        RenderUtils.getLerpedBox(this.Rd, var2),
                ...
                if (this.Re != null && this.Re.sP().contains(this.Rd.getPos())) {
                    ...
                    for (AnimalEntity var5 : this.ahS(this.Re)) {
                        if (var5 != this.Rd) {
                            var3.submit(
                                    RenderUtils.getLerpedBox(var5, var2),
                                    this.renderOtherAnimalColor.get().withAlpha(255));
                        }
                    }
                }
