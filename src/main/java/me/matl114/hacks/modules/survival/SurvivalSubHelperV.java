...
public class SurvivalSubHelperV {
   ...
   private static final Codec<List<BlockPos>> a = Codec.LONG.xmap(BlockPos::fromLong, BlockPos::asLong).listOf();
   private final String d;
   public static final Codec<SurvivalSubHelperV> b = RecordCodecBuilder.create(
