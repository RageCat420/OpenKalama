    ...
    public void execute(InteractManager manager, PlayerEntity player) {
        ...
        if (var3 != null) {
            ...
            if (var4 != null) {
                ...
                Runnable var6 = var5
                        ? InvExtra.INSTANCE.uh(var4.index())
                        : InvExtra.INSTANCE.swapInventoryIndexToHand(var4.index());
                if (var6 != null) {
                    ...
                    ActionResult var9 =
                            MinecraftClient.getInstance().interactionManager.interactItem(player, var8);
                    if (InteractManager.INSTANCE.logAction.get()) {
                        MutableText var10 = VItem.w().l((ItemStack) var4.val());
                        manager.logI18NSub(
                                "Interact", "message.module.interact-manager.interact.use", new Object[] {var10});
                    }
