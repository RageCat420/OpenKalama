      ...
      if (var5 != null) {
         ...
         if (var6 != null) {
            MinecraftClient.getInstance()
               .interactionManager
               .attackBlock(var4, Direction.getFacing(MinecraftClient.getInstance().player.getEyePos().subtract(var4.toCenterPos())));
            if (InteractManager.INSTANCE.logAction.get()) {
               manager.logI18NSub("Interact", "message.module.interact-manager.interact.mine", new Object[]{ChatUtils.t(Vec3d.of(var4))});
            }
