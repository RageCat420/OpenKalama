...
public class MoveSubHelperL {
    ...
    public void tickUpdate(PlayerEntity player) {
        AttributeContainer var2 = new AttributeContainer(DefaultAttributeRegistry.get(
        ...
        this.h = MovTasks.isCollidingWithEnvironment(
                player, var12.withMinY(var12.maxY).withMaxY(var12.maxY + 0.42));
        this.a = Tasks.b();
    }
