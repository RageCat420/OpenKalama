...
public class ForwardTp extends BaseModule {
    ...
    public ForwardTp() {
        super("ForwardTp");
        this.quickMove = this.hotkey(this.TS.add("quick-move"), new MultiKeyBind())
                .registerHotkey(HotKeyUtils.c(this::quickMovFront))
                .build();
        this.quickToWall = this.hotkey(this.TS.add("quick-to-wall"), new MultiKeyBind())
                .registerHotkey(HotKeyUtils.c(this::alN))
                .build();
        this.maxDistance = this.builder(this.TS.add("max-distance"), DoubleRef.TYPE)
                .defaultValue(120.0)
                .validator(Configs.doubleRange(0.0, 114514.0))
                .build();
        this.ignoreMoveCollision = this.builder(this.TS.add("ignore-move-collision"), FlagRef.TYPE)
                .defaultValue(true)
                .build();
        this.distance = 0.1;
    }
