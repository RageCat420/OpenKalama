...
public class MoveTimer extends BaseModule {
    ...
    public MoveTimer() {
        super("MoveTimer");
        this.timerEnableHotkey = this.toggleHotkey(
                        this.QJ.add("timer-enable-hotkey"), new MultiKeyBind(), this.QJ.add("timer-enable"))
                .build();
        this.multiply = this.builder(this.QJ.add("multiply"), IntRef.TYPE)
                .defaultValue(0)
                .validator(Configs.d)
                .build();
