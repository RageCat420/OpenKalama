...
public class LegacySnapRotManager extends BaseModule {
   ...
   public void registerAll() {
      ...
      this.registerListener(Listener.ap().getChannel(PlayerMoveC2SPacket.class), this::onSendPlayerPosRotPacket, Integer.MIN_VALUE);
   }
   ...
   public void onSendPlayerPosRotPacket(Event<PlayerMoveC2SPacket> event) {
      if (this.betweenViaPacket && ViaFabricPlusHooks.isSupportDupRot() && event.b instanceof Full var3 && var3 instanceof PlayerMoveC2SPacketAccess var4) {
