...
public class AntiChunkLag extends BaseModule implements HackUtilHelperJ {
        ...
        for (int var8 = -var2; var8 <= var2; var8++) {
            for (int var9 = -var2; var9 <= var2; var9++) {
                ...
                if (!WorldUtils.isChunkLoaded(var10.x, var10.z)) {
                    ...
                    double var13 = Math.max(
                            MathUtils.getBoxDistance(var5.x, var12.minX, var12.maxX),
                            MathUtils.getBoxDistance(var5.z, var12.minZ, var12.maxZ));
                    if (var13 < var6) {
                        var3 = true;
                        break label92;
                    }
                ...
                for (int var17 = 0; var17 <= var2; var17++) {
                    for (int var18 = 0; var18 <= var2; var18++) {
                        ...
                        if (!WorldUtils.isChunkLoaded(var19.x, var19.z)) {
                            ...
                            double var22 = Math.max(
                                    MathUtils.getBoxDistance(var5.x, var21.minX, var21.maxX),
                                    MathUtils.getBoxDistance(var5.z, var21.minZ, var21.maxZ));
                            if (var22 < var6) {
                                var16 = true;
                                break label66;
                            }
    ...
    public AntiChunkLag() {
        ...
        this.J = this.toggleHotkey(this.aD.addHotkey(), new MultiKeyBind(), this.aD.addEnable())
                .build();
        this.predictVelocity = this.intBuilder(this.aD.add("predict-velocity"))
                .defaultValue(48)
                .validator(Configs.e)
                .build();
