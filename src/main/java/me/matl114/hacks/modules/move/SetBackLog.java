...
public class SetBackLog extends BaseModule {
    ...
    public Vec3d ri;
    public final FlagRef rd =
            this.flagBuilder(this.gQ.add("log-resync-packets")).build();
    ...
    public SetBackLog() {
        ...
        this.logResyncFormat = this.builder(this.gQ.add("log-resync-format"), StringFormat.class)
                ...
                .build();
        this.checkSetbackPackets =
                this.flagBuilder(this.gQ.add("check-setback-packets")).build();
