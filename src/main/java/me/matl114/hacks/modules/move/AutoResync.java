...
public class AutoResync extends BaseModule {
   ...
   public Vec2f Up;
   public final FlagRef Ug = this.flagBuilder(this.gQ.add("auto-resync-rotation")).build();
   public final FlagRef Uh = this.flagBuilder(this.gQ.add("auto-resync-rot-modify-packet")).build();
   ...
   public AutoResync() {
      super("AutoResync");
      this.autoResyncVelocity = this.flagBuilder(this.gQ.add("auto-resync-velocity")).build();
      this.autoResyncPos = this.flagBuilder(this.gQ.add("auto-resync-pos")).build();
      this.autoResyncDistance = this.builder(this.gQ.add("auto-resync-distance"), DoubleRef.TYPE).defaultValue(10.0).build();
      this.logAutoResyncRequest = this.flagBuilder(this.gQ.add("log-auto-resync-request")).build();
      this.autoResyncRequestExpireTick = this.builder(this.gQ.add("auto-resync-request-expire-tick"), IntRef.TYPE)
         .defaultValue(10)
         .validator(Configs.e)
         .build();
      this.autoResyncRequestRecursively = this.flagBuilder(this.gQ.add("auto-resync-request-recursively")).build();
      this.Uo = 0;
      this.Up = null;
      INSTANCE = this;
   }
               ...
               if (!mc.player.getPos().equals(Vec3d.ZERO)) {
                  if (mc.interactionManager.getCurrentGameMode() != GameMode.SPECTATOR) {
                     ...
                     if (this.Uf > Tasks.b() && this.Ue != null) {
                        ...
                        if (var6 > 1.0E-4 && var6 < MathUtils.b(128) && var8 > 1.0E-4 && var8 < MathUtils.b(128)) {
                           if (this.logAutoResyncRequest.get()) {
                              Debug.b("Auto Resync triggered!");
                           }

                           mc.getNetworkHandler().sendPacket(new TeleportConfirmC2SPacket(var4.getTeleportId()));
                     ...
                     if (this.autoResyncPos.get()) {
                        ...
                        if (mc.world.getChunkManager().isChunkLoaded(var17.getX() >> 4, var17.getZ() >> 4)) {
                           ...
                           if (this.autoResyncDistance.get() > 0.0 && var11 < MathUtils.a(this.autoResyncDistance.get())) {
                              mc.getNetworkHandler().sendPacket(new TeleportConfirmC2SPacket(var19.getTeleportId()));
                     ...
                     if (var16 && var21 != null) {
                        event.context(new PlayerPositionLookS2CPacket(var18.getX(), var18.getY(), var18.getZ(), var13, var14, var21, var18.getTeleportId()));
                     }
                  }
               }
            }
