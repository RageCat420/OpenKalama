...
public class MoveSubHelperZ extends MoveSubHelperY {
    int Fq;
    Vec3d Fk;
    MoveSubHelperPX Me;
    Vec3d Fl;
    ...
    public MoveSubHelperZ(NoFall module) {
        super(module);
        this.Fk = null;
        this.Fm = 0;
        this.Me = MoveSubHelperPX.mv;
        this.Fp = 0;
        this.Fq = 0;
        this.modifyYaw = 0.0F;
        this.Fs = null;
    ...
    public void gz(Event<LegalMovementManager> movementManagerEvent) {
        if (this.Ft && this.Fs != null) {
            if (this.Fp >= 3 && this.Fj == Tasks.b()) {
                this.Fp = 0;
                this.Fu = Tasks.b();
                this.Fs.rx(true).ry(false).rB(false);
            }
    ...
    public void applyBeforeMovementPacketModify(Event<LegalMovementManager> movementManagerEvent) {
        ...
        if (this.module.isActive()) {
            ...
            if (this.Me == MoveSubHelperPX.mx) {
                this.Me = MoveSubHelperPX.mv;
            } else if (this.Me != MoveSubHelperPX.mv && this.Me != null) {
                if (this.Me == MoveSubHelperPX.mw) {}
            } else {
                ...
                if (var3 && !var2.b && ((ClientPlayerEntity) var2.a).isOnGround()) {
                    ...
                    MinecraftClient.getInstance()
                            .player
                            .setPosition(((LegalMovementManager) movementManagerEvent.b)
                                    .c.g.withAxis(
                                            Axis.Y,
                                            MinecraftClient.getInstance().player.getY()));
                    this.Me = MoveSubHelperPX.mw;
                    this.Mc = true;
                    MinecraftClient.getInstance().player.setOnGround(true);
    ...
    public void applyPreTickModify(Event<LegalMovementManager> movementManagerEvent) {
        ...
        if (this.module.isActive()) {
                    ...
                    if (this.Fl != null && Tasks.b() <= this.Fm + 1) {
                        ...
                        if (!var9.aar()) {
                            ...
                            if (var7.ru()) {
                                if (var7.rE()) {
                                    var4 = true;
                                    PlayerStateManager.nT(
                                            MinecraftClient.getInstance().player,
                                            MinecraftClient.getInstance().player.getYaw() + 180.0F);
                                } else if (!var7.rF()) {
                                    if (var7.rG()) {
                                        var4 = true;
                                        PlayerStateManager.nT(
            ...
            } else if (this.Me == MoveSubHelperPX.mx) {
                this.Me = MoveSubHelperPX.mv;
            }
