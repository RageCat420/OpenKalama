...
public class TpaCommand extends BaseModule {
   ...
   public boolean onMark(CommandExecution var1, ArgumentInputStream re, ArgumentReader reader) {
      ...
      RenderTasks.i(new KalamaHelperHelperCX(new KalamaHelperHelperDX(var5.dimensions.getBoxAt(MovTasks.R), Color.GREEN)).d(() -> MovTasks.R != var8));
      return true;
   }
   ...
   public void st(MainCommand mainCommand) {
      ...
      var2.subBuilder(SubCommand.bo())
         ...
         .A(
            KalamaHelperHelperA.<me.matl114.utils.commands.params.impl.KalamaHelperHelperA, ExecutePos>b(
      ...
      var2.subBuilder(SubCommand.bo())
         ...
         .A(
            new DispatchArgumentType<ExecutePos>("extra")
               ...
               .registerArgumentDispatcher(0, "target", KalamaHelperHelperA.<KalamaHelperHelperM, ExecutePos>b(KalamaHelperHelperM::new).B("dispatch_tpa").v())
               .registerArgumentDispatcher(0, "player", KalamaHelperHelperA.a().B("dispatch_player").d(() -> EntityUtils.getWorldPlayerNames(false)).v())
               .registerDispatcher((p, args) -> true, KalamaHelperHelperA.a().B("dispatch_default").v())
         )
      ...
      var2.subBuilder(SubCommand.bo())
         ...
         .A(KalamaHelperHelperA.<KalamaHelperHelperM, ExecutePos>b(KalamaHelperHelperM::new).B("tpa_target").v())
