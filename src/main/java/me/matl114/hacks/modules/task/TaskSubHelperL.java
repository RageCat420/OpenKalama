...
public record TaskSubHelperL(Map<String, String> ipToFolder, Map<String, String> ipProxy) {
    public static final Codec<TaskSubHelperL> CODEC = RecordCodecBuilder.create(oinstance -> oinstance
            .group(
                    Codec.unboundedMap(Codec.STRING, Codec.STRING)
                            .optionalFieldOf("persistent-storage-name-mapper", Map.of())
                            .forGetter(TaskSubHelperL::ipToFolder),
                    Codec.unboundedMap(Codec.STRING, Codec.STRING)
                            .optionalFieldOf("ip-proxies", Map.of())
                            .forGetter(TaskSubHelperL::ipProxy))
