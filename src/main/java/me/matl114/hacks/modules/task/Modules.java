...
public class Modules extends BaseModule {
    ...
    public final EnumRef<ModuleSettings$HotkeyPolicy> Jf = this.builder(
                    this.Je.add("hotkey-work-policy"), ModuleSettings$HotkeyPolicy.class)
    ...
    public Modules() {
        super("Modules");
        this.toggleKeysStopVanilla = this.builder(this.Je.add("toggle-keys-stop-vanilla"), FlagRef.TYPE)
                .defaultValue(true)
                .build();
        this.moduleToggleNotify = this.builder(this.Je.add("module-toggle-notify"), FlagRef.TYPE)
                .defaultValue(true)
                .build();
        ...
        this.moduleOffNotifyFormat = this.builder(this.Je.add("module-off-notify-format"), StringFormat.class)
                ...
                .build();
        this.compressModuleToggleMessage =
                this.flagBuilder(this.Je.add("compress-module-toggle-message")).build();
