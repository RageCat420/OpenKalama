...
public class PacketOrderManager extends BaseModule {
    ...
    public void fv(Event<PlayerMoveC2SPacket> event) {
        this.bQ = true;
        PlayerMoveC2SPacketAccess.Cause var2 =
                PlayerMoveC2SPacketAccess.of((PlayerMoveC2SPacket) event.b).getCause();
    ...
    public void registerAll() {
        ...
        this.registerListener(
                Listener.ap().getChannel(PlayerInteractEntityC2SPacket.class), this::onInteract, Integer.MAX_VALUE);
        this.registerListener(
                Listener.ap().getChannel(PlayerInteractBlockC2SPacket.class), this::fr, Integer.MAX_VALUE);
        this.registerListener(
                Listener.ap().getChannel(PlayerActionC2SPacket.class), this::onPlayerAction, Integer.MAX_VALUE);
        this.registerListener(
                Listener.ap().getChannel(ClientCommandC2SPacket.class), this::onEntityAction, Integer.MAX_VALUE);
