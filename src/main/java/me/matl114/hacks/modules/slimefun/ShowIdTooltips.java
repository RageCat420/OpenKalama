...
public class ShowIdTooltips extends BaseModule {
   ...
   public final FlagRef ae = this.builder(this.fo.add("enable-tooltips-display"), Boolean.class).defaultValue(true).build();
            ...
            if ((var3 = ItemStackUtils.getBukkitValue(var3)) != null && var3.get(ny) instanceof NbtIntArray var5) {
               ...
               for (int var8 = 0; var8 < 6; var8++) {
                  if ((var6 <= var8 || var11[var8] != 0) && var11[var8] != 1 && var11[var8] != 3) {
                     ...
                     var7.append(var11[var8] % 2 == 0 ? nz[var8] : nA[var8]).append(var11[var8] / 2 == 0 ? nz[var8] : nA[var8]);
                  }
               }

               lores.add(Text.literal("基因工程: ").formatted(Formatting.GRAY).append(Text.literal(var7.toString()).formatted(Formatting.DARK_PURPLE)));
            }
            ...
            try {
               if (var4.contains("cultivation:seed_instance")) {
                  if (var4.get("cultivation:seed_instance") instanceof NbtCompound var6) {
                     ...
                     int var15 = var6.get("cultivation:growth_speed") instanceof NbtInt var13 ? var13.intValue() : 0;
   ...
   public void onTooltips(Event<List<Text>> event) {
      if (this.isActive()) {
         ...
         var4.add(Text.literal("粘液物品ID: ").formatted(Formatting.GRAY).append(Text.literal(var3).formatted(Formatting.GREEN)));
