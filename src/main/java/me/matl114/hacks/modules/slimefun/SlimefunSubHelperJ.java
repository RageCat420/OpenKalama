...
public class SlimefunSubHelperJ implements IRecipeEntry {
    ...
    final ItemStack JV;
    String JR;
    public static final Codec<SlimefunSubHelperJ> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    public String toString() {
        return "SlimefunRecipeEntry[ rid = " + this.JR + " , id = " + this.id + " , ingredient = " + this.JS.toString()
                + ", output = " + this.JT + " ]";
    }
