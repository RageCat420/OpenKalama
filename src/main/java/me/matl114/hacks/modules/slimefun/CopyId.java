      ...
      if (var2 != null && var1 != null) {
         ...
         if (var3 != null) {
            ...
            if (var9 != null) {
               ...
               Debug.b(Text.literal("成功将Slimefun ID拷贝至你的剪切板和公共参数! 值: ").formatted(Formatting.GREEN).append(Text.literal(var9).formatted(Formatting.WHITE)));
               return true;
            } else {
               String var8 = Registries.ITEM.getId(var3.getItem()).getPath().toUpperCase(Locale.ROOT);
               var1.keyboard.setClipboard(var8);
               Debug.b(Text.literal("该物品不是Slimefun物品,拷贝原版ID!").formatted(Formatting.GREEN).append(Text.literal(var8).formatted(Formatting.WHITE)));
               return true;
            }
         } else {
            return false;
