...
public class NameTag extends INameTag {
            ...
            for (byte var5 = 0; var5 < var4; var5 += 3) {
                ...
                if (var6 != var5) {
                    ...
                    for (int var8 = var5; var8 < var6; var8++) {
                        var7 += 9.0F;
                        var7 += mc.textRenderer.getTextHandler().getWidth((StringVisitable)
                                ((Entry) var3.get(var8)).getValue());
                    }
                    ...
                    for (int var11 = var5; var11 < var6; var11++) {
                        ...
                        vdraw.z(
                                mc.textRenderer,
                                ((Text) var9.getValue()).asOrderedText(),
                                0,
                                0,
                                this.potionColor.get().withAlpha(255),
                                true);
                        vdraw.f()
                                .translate(
                                        mc.textRenderer.getTextHandler().getWidth((StringVisitable)
                                                        ((Entry) var3.get(var11)).getValue())
                                                + 1.0F,
                                        0.0F);
                    }
    ...
    public void onRenderPlayer(
            RenderSubHelperIX player, VDrawContext vdraw, Function<Vec3d, Vector2d> projector, float tick) {
            ...
            for (int var6 = 0; var6 < var3.length; var6++) {
                if (var3[var6].isEmpty()) {
                    ...
                    if (this.equipmentDamage.get().isNotIn(new ConfigEnum[] {ItemStackDisplayUtils$DamageDisplay.NONE})
                            ...
                            && var11.isDamageable()) {
                        var5 = true;
                        OrderedText var8 = ItemStackDisplayUtils.getDamageShowText(var11, this.equipmentDamage.get())
                                .asOrderedText();
                        ...
                        vdraw.z(
                                mc.textRenderer,
                                var8,
                                var4 + var6 * 18 + 9 + (int) ((-var9 - 1.0F) / 2.0F),
                                -25,
                                var10,
                                true);
                    }
    ...
    protected void initializeModuleSettings() {
        this.playerExtraHeight = this.doubleBuilder(this.GE.add("player-extra-height"))
                .defaultValue(1.0)
                .build();
        this.playerSize =
                this.doubleBuilder(this.GE.add("player-size")).defaultValue(1.0).build();
