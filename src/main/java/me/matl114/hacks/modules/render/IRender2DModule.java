...
public class IRender2DModule extends BaseModule {
   ...
   public IRender2DModule(String name) {
      ...
      this.hotkey2 = this.moduleEntry(this.he.add("hotkey"), new MultiKeyBind(), this.he.add("enable")).build();
      this.hJ();
      this.right2 = this.flagBuilder(this.he.add("right")).build();
      this.pos2 = this.builder(this.he.add("pos"), WidgetPos.class).defaultValue(new WidgetPos(0, 0.0, 0.0, 0, 0)).build();
