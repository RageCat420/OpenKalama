...
public class SleepMode extends BaseModule {
        ...
        if (this.aim()) {
            ...
            if (this.Ri != null) {
                ScreenUtils.simulateMouseScroll(
                        this.Ri, ((MouseScrollAction) event.b).horizontal(), ((MouseScrollAction) event.b).vertical());
            }
        }
    }
        ...
        if (this.ensureSleepingScreen()) {
            if (this.Rj != null) {
                ...
                if (this.Rk) {
                    ...
                    int var3 = (int) (mc.mouse.getX()
                            * mc.getWindow().getScaledWidth()
                            / mc.getWindow().getWidth());
                    int var4 = (int) (mc.mouse.getY()
        ...
        if (this.aim()) {
            ...
            if (this.Ri != null) {
                ScreenUtils.simulateMouseButton(
                        this.Ri,
                        ((MouseClickAction) event.b).eventButton(),
                        ((MouseClickAction) event.b).action(),
                        ((MouseClickAction) event.b).mode());
            }
        }
    }
        ...
        if (this.aim()) {
            ...
            if (this.Ri != null) {
                ScreenUtils.simulateKeyAction(
                        this.Ri, (Integer) event.c[0], (Integer) event.c[1], (Integer) event.c[2], (Integer)
                                event.c[3]);
            }
        }
    }
    ...
    public void aik(ArgumentInputStream re) {
        ...
        if (var2 != 1 && var2 != 2) {
            ...
            if ("confirm".equals(var3)) {
                ...
                Debug.b("使用sleep confirm 确认进入睡眠模式, 进入睡眠模式后可以按 "
                        + RenderTasks.E().aiE() + " 键离开");
            }
        }
    }
    ...
    public SleepMode() {
        super("SleepMode");
        this.oq = this.hotkey(Configs.i, this.ow.add("wake-up-screen").toPath())
                .defaultValue(new MultiKeyBind(300))
                .build();
        this.sleepModeRunnerOptimize =
                this.flagBuilder(this.ow.add("sleep-mode-runner-optimize")).build();
        this.Rh = false;
        this.Rk = false;
        INSTANCE = this;
    }
