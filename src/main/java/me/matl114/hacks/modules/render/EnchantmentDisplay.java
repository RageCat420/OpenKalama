...
public class EnchantmentDisplay extends BaseModule {
   ...
   public final FlagRef ae = this.builder(this.iv.addEnable(), Boolean.class).defaultValue(false).build();
   public static final String cl = "kalama";
   public static final String cm = "enchantment_icon/";
   public final FlagRef Ce = this.builder(this.iv.add("mace"), Boolean.class).defaultValue(true).build();
   ...
   public EnchantmentDisplay() {
      ...
      this.weapon = this.builder(this.iv.add("weapon"), Boolean.class).defaultValue(true).build();
      this.equippable = this.builder(this.iv.add("equippable"), Boolean.class).defaultValue(true).build();
      this.tool = this.builder(this.iv.add("tool"), Boolean.class).defaultValue(true).build();
      this.bow = this.builder(this.iv.add("bow"), Boolean.class).defaultValue(false).build();
      this.Cj = new HashMap<>();
      this.Ck = new HashMap<>();
      ...
      for (Item var2 : Registries.ITEM) {
         if (var2 instanceof MaceItem var3) {
            ...
            this.Cj.put(var2, List.of(Enchantments.PROTECTION, Enchantments.BLAST_PROTECTION, Enchantments.FIRE_PROTECTION));
