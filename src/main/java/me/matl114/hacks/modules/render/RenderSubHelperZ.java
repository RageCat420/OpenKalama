...
class RenderSubHelperZ extends HashMap<String, List<Item>> {
   RenderSubHelperZ() {
      ...
      this.put("CLT_PLANT_ELDER_GUARDIAN", StorageDisplay.ofNullableList(Items.PRISMARINE_SHARD, Items.PRISMARINE_CRYSTALS, Items.SPONGE));
      ...
      this.put("CLT_PLANT_SPIDER", StorageDisplay.ofNullableList(Items.SPIDER_EYE, Items.FERMENTED_SPIDER_EYE, Items.STRING));
      ...
      this.put("CLT_PLANT_DIM_LIT", StorageDisplay.ofNullableList(Items.OCHRE_FROGLIGHT, Items.PEARLESCENT_FROGLIGHT, Items.VERDANT_FROGLIGHT));
      ...
      this.put("CLT_PLANT_DROWNED", StorageDisplay.ofNullableList(Items.ROTTEN_FLESH, Items.NAUTILUS_SHELL, Items.TRIDENT));
      ...
      this.put(
         "CLT_PLANT_MUSHROOM",
         StorageDisplay.ofNullableList(Items.BROWN_MUSHROOM, Items.RED_MUSHROOM, Items.CRIMSON_FUNGUS, Items.WARPED_FUNGUS, Items.MYCELIUM)
      );
      ...
      this.put("CLT_PLANT_FISH", StorageDisplay.ofNullableList(Items.COD, Items.SALMON, Items.TROPICAL_FISH, Items.PUFFERFISH));
      this.put(
         "CLT_PLANT_RAINBOW",
         StorageDisplay.ofNullableList(
            Items.BLACK_DYE,
      ...
      this.put("CLT_PLANT_GUARDIAN", StorageDisplay.ofNullableList(Items.PRISMARINE_SHARD, Items.PRISMARINE_CRYSTALS));
      ...
      this.put("CLT_PLANT_TURTLE", StorageDisplay.ofNullableList(Items.TURTLE_SCUTE, Items.SEAGRASS, Items.TURTLE_EGG));
      this.put("CLT_PLANT_PHANTOM", StorageDisplay.ofNullableList(Items.PHANTOM_MEMBRANE));
      this.put("CLT_PLANT_ENDER_DRAGON", StorageDisplay.ofNullableList(Items.DRAGON_BREATH, Items.DRAGON_HEAD, Items.DRAGON_EGG));
      ...
      this.put(
         "CLT_PLANT_IGNEOUS", StorageDisplay.ofNullableList(Items.GRANITE, Items.DIORITE, Items.ANDESITE, Items.CALCITE, Items.TUFF, Items.DRIPSTONE_BLOCK)
      );
   }
}
