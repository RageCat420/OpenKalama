...
public class Zoom extends BaseModule {
    ...
    public FlagRef ae =
            this.builder(this.IJ.addEnable(), Boolean.class).defaultValue(true).build();
    ...
    public Zoom() {
        ...
        this.scrollScale = this.builder(this.IJ.add("scroll-scale"), Boolean.class)
                .defaultValue(true)
                .build();
        this.defaultZoom = this.doubleBuilder(this.IJ.add("default-zoom"))
                .defaultValue(3.0)
                .validator(Configs.doubleRange(0.0, 114514.0))
                .build();
        this.minZoomScale = this.doubleBuilder(this.IJ.add("min-zoom-scale"))
                .defaultValue(1.0)
                .validator(Configs.doubleRange(0.0, 114514.0))
                .build();
