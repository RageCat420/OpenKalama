...
public class EquipmentHud extends IRender2DModule {
    ...
    public EnumRef<ItemStackDisplayUtils$DamageDisplay> Vl = this.builder(
                    this.Cn.add("damage-display"), ItemStackDisplayUtils$DamageDisplay.class)
    ...
    public EquipmentHud() {
        super("EquipmentHud");
        this.damageDisplayPosition = this.builder(this.Cn.add("damage-display-position"), Direction2d.class)
                .defaultValue(Direction2d.DOWN)
                .build();
        this.handPos = this.builder(this.Cn.add("hand-pos"), WidgetPos.class)
                .defaultValue(new WidgetPos(1, 0.0, 0.0, -60, 0))
                .build();
        this.offhandPos = this.builder(this.Cn.add("offhand-pos"), WidgetPos.class)
                .defaultValue(new WidgetPos(1, 0.0, 0.0, 40, 0))
                .build();
        this.headPos = this.builder(this.Cn.add("head-pos"), WidgetPos.class)
                .defaultValue(new WidgetPos(1, 0.0, 0.0, -40, 0))
                .build();
        this.chestPos = this.builder(this.Cn.add("chest-pos"), WidgetPos.class)
                .defaultValue(new WidgetPos(1, 0.0, 0.0, -20, 0))
                .build();
        this.legPos = this.builder(this.Cn.add("leg-pos"), WidgetPos.class)
                .defaultValue(new WidgetPos(1, 0.0, 0.0, 0, 0))
                .build();
        this.feetPos = this.builder(this.Cn.add("feet-pos"), WidgetPos.class)
                .defaultValue(new WidgetPos(1, 0.0, 0.0, 20, 0))
                .build();
