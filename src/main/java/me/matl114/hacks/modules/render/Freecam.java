...
public class Freecam extends BaseModule implements HackUtilHelperJ {
    ...
    public void registerAll() {
        ...
        this.registerListener(
                Listener.ap().getChannel(PlayerInteractEntityC2SPacket.class), this::onStopInteractWithSelf);
    ...
    public Freecam() {
        ...
        this.el = this.toggleHotkey(
                        Configs.i,
                        this.ek.add("enable-hotkey").toPath(),
                        new MultiKeyBind(85),
                        this.ek.add("enable").toPath())
                .build();
        this.speed = this.builder(this.ek.add("speed"), DoubleRef.TYPE)
                .defaultValue(1.0)
                .validator(Configs.doubleRange(0.0, 100000.0))
                .build();
