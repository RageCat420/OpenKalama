...
class RenderSubHelperW {
    ...
    public static RenderSubHelperW of(PersistentProjectileEntity arrow, float tickDelta) {
        return new RenderSubHelperW(
                RenderUtils.getLerpedPos(arrow, tickDelta), arrow.getVelocity(), RenderSubHelperAc.Wo, arrow);
    }
    ...
    public static RenderSubHelperW i(CrossbowUser user, float tickDelta) {
        ...
        Vec3d var6 = new Vec3d(var2.getX(), var2.getEyeY() - 0.1F, var2.getZ())
        ...
        if (this.c.lengthSquared() < 1.0E-5) {
            ...
            for (int var7 = 0; var7 < ticks; var7++) {
                ...
                if (var6.size() > 2) {
                    ...
                    if (RaycastUtils.raycastAnySolidBlock(this.e, var8, var2)
                            || RaycastUtils.raycastHitAnyEntityExceptPlayer(this.e, var8, var2)) {
                        break;
                    }
                }
            }
    ...
    public static RenderSubHelperW d(AbstractSkeletonEntity entity, float tickDelta) {
        Vec3d var2 = new Vec3d(entity.getX(), entity.getEyeY() - 0.1F, entity.getZ())
    ...
    private static Vec3d getHandOffset(PlayerEntity player, Hand hand) {
        ...
        Arm var4 = (Arm) net.minecraft.client.MinecraftClient.getInstance()
                .options
                .getMainArm()
                .getValue();
    ...
    public static RenderSubHelperW g(PlayerEntity player, RangedWeaponItem weaponItem, Hand hand, float tickDelta) {
        ...
        Vec3d var5 = new Vec3d(player.getX(), player.getEyeY() - 0.1F, player.getZ())
                .add(var4)
