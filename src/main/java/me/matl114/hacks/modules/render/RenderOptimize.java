...
public class RenderOptimize extends BaseModule {
    ...
    public void onEntityTick(Event<Entity> event) {
        ...
        if (var2 instanceof ItemEntity var3 && this.optimizeItemTick.get()) {
            ...
            if (var6 != null
                    && var6.getPos().squaredDistanceTo(var3.getPos()) > MathUtils.a(this.itemCullingDistance.get())) {
                event.cancel();
                return;
            }
    ...
    public RenderOptimize() {
        super("Optimize");
        this.optimizeItemTick =
                this.flagBuilder(this.xB.add("optimize-item-tick")).build();
        this.itemCullingDistance = this.builder(this.xB.add("item-culling-distance"), DoubleRef.TYPE)
                .defaultValue(40.0)
                .build();
        this.optimizeParticleTick =
                this.flagBuilder(this.xB.add("optimize-particle-tick")).build();
        this.optimizeArmorStandTick =
                this.flagBuilder(this.xB.add("optimize-armor-stand-tick")).build();
        this.optimizeEntityLabelRender =
                this.flagBuilder(this.xB.add("optimize-entity-label-render")).build();
        this.entityLabelRenderCullingDistance = this.builder(
                        this.xB.add("entity-label-render-culling-distance"), DoubleRef.TYPE)
                .defaultValue(64.0)
                .build();
        this.optimizeBlockLabelRender =
                this.flagBuilder(this.xB.add("optimize-block-label-render")).build();
        this.blockLabelRenderCullingDistance = this.builder(
                        this.xB.add("block-label-render-culling-distance"), DoubleRef.TYPE)
                .defaultValue(20.0)
                .build();
        this.optimizeCullingEnable =
                this.flagBuilder(this.xB.add("optimize-culling-enable")).build();
        this.optimizeCullingEnableHotkey = this.moduleEntry(
                        this.xB.add("optimize-culling-enable-hotkey"),
                        new MultiKeyBind(),
                        this.xB.add("optimize-culling-enable"))
                .build();
        this.xL = this.builder(this.xB.add("optimize-culling-entity-types"), EntrySet.<EntityType<?>>parameter())
                ...
                .build();
        this.xM = this.builder(
                        this.xB.add("optimize-culling-block-entity-types"), EntrySet.<BlockEntityType<?>>parameter())
                .defaultValue(new EntrySet<BlockEntityType<?>>(
                        new Regex("^((.*sign)|barrel|skull|(.*chest)|enchanting_table)$"),
                        Registries.BLOCK_ENTITY_TYPE))
                .build();
        this.xN = this.builder(
                        this.xB.add("optimize-culling-block-entity-types"), EntrySet.<ParticleType<?>>parameter())
                .defaultValue(new EntrySet<ParticleType<?>>(new Regex("^(.*)$"), Registries.PARTICLE_TYPE))
                .build();
        this.optimizeCullingRadius = this.builder(this.xB.add("optimize-culling-radius"), DoubleRef.TYPE)
                .defaultValue(64.0)
                .build();
        this.optimizeCullingUseRaycast =
                this.flagBuilder(this.xB.add("optimize-culling-use-raycast")).build();
    ...
    public boolean shouldCancelShowDisplayName(Entity entity) {
        return this.optimizeEntityLabelRender.get()
                        ...
                        && !var2.isMetaEmpty()
                        && var2.getMetadata().b(this, "kalama:render_optimize/render_controller")
                                instanceof RenderOptimize$RenderController var4
                ? var4.a
                : false;
    }
                            ...
                            if (var16 instanceof MetadataHolder var17) {
                                ...
                                if (this.xM.get().test(var18)) {
                                    ...
                                    RenderOptimize$RenderController var20 = var19.c(
                                            this,
                                            "kalama:render_optimize/render_controller",
                                            RenderOptimize$RenderController::new);
                                    ...
                                    RenderOptimize$RenderController var24 =
                                            var23.b(this, "kalama:render_optimize/render_controller");
                                    if (var24 != null) {
                                        var24.c = false;
                                    }
                                }
        ...
        if (!event.d() && this.optimizeCullingEnable.get()) {
            ...
            if (this.xM.get().test(var3)) {
                ...
                if (var2 instanceof MetadataHolder var7
                        && !var7.isMetaEmpty()
                        && var7.getMetadata().b(this, "kalama:render_optimize/render_controller")
                                instanceof RenderOptimize$RenderController var9
                        && var9.c) {
                    event.cancel();
                }
            }
    ...
    public void onEntityLabelShowTick(Event<Entity> event) {
        if (this.optimizeEntityLabelRender.get()) {
            ...
            if (var2.hasCustomName() && var2 instanceof MetadataHolder var3) {
                ...
                RenderOptimize$RenderController var5 =
                        var4.c(this, "kalama:render_optimize/render_controller", RenderOptimize$RenderController::new);
        ...
        if (var2 instanceof MetadataHolder var3) {
            ...
            if (this.optimizeCullingEnable.get()) {
                if (this.xL.get().test(var5)) {
                    ...
                    RenderOptimize$RenderController var7 = var6.c(
    ...
    public void Kw(Event<Entity> event) {
        if (!event.d() && this.optimizeCullingEnable.get()) {
            ...
            if (var2 instanceof MetadataHolder var3
                    && !var3.isMetaEmpty()
                    && var3.getMetadata().b(this, "kalama:render_optimize/render_controller")
                            instanceof RenderOptimize$RenderController var5
                    && var5.c) {
                event.cancel();
            }
        }
    ...
    public void onBlockEntityTick(Event<BlockEntityTickInvoker> event) {
        ...
        if (var4 instanceof MetadataHolder var5 && var4 instanceof SignBlockEntity) {
            ...
            RenderOptimize$RenderController var7 =
                    var6.c(this, "kalama:render_optimize/render_controller", RenderOptimize$RenderController::new);
