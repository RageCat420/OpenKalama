...
public class CustomOverlay extends BaseModule {
    ...
    public CustomOverlay() {
        super("CustomOverlay");
        this.customBackgroundColor = this.builder(this.aV.add("custom-background-color"), IntRef.TYPE)
                .defaultValue(-1)
                .build();
        this.customProgressBarColor = this.builder(this.aV.add("custom-progress-bar-color"), WrapColor.class)
