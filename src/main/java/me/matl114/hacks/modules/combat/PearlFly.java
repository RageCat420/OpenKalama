...
public class PearlFly extends BaseModule {
        ...
        if (!checkNull()) {
            if (this.rY.get()) {
                ...
                if (this.useWasdControl.get()) {
                    ...
                    BlockPos var9 = var6.add(var3.getVector().multiply(var7.ro()))
                            .add(var8.getVector().multiply(var7.rp()));
    ...
    public PearlFly() {
        ...
        this.J = this.toggleHotkey(this.rX.addHotkey(), new MultiKeyBind(), this.rX.addEnable())
                .build();
        ...
        this.autoActivateRange = this.doubleBuilder(this.rX.add("auto-activate-range"))
                .defaultValue(0.35)
                .build();
        this.useWasdControl = this.flagBuilder(this.rX.add("use-wasd-control")).build();
        this.enableJumpUp = this.builder(this.rX.add("enable-jump-up"), Boolean.class)
                .defaultValue(true)
                .build();
