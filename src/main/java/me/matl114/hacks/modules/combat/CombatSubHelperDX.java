...
public class CombatSubHelperDX extends CombatSubHelperOX implements CombatSubHelperG {
        ...
        if (PlayerStateManager.INSTANCE.jh < 1.0E-6 && this.s > 1.0E-6) {
            ...
            if (this.t.uS) {
                if (var3) {
                    ...
                    Vec3d var9 = MovTasks.simulateMovement(
        ...
        if (this.t.uS) {
            ...
            BlockHitResult var8 = MinecraftClient.getInstance()
                    ...
                    .raycast(new RaycastContext(
                            ...
                            MinecraftClient.getInstance().player));
            if (var8 != null
                    && var8.getType() != Type.MISS
                    && var8.getPos().squaredDistanceTo(var7) <= MathUtils.a(2.0 * var5)) {
                ...
                for (BlockPos var17 : var11) {
                    ...
                    if (TargetSelector.INSTANCE.akm(var18, this.t.uI.getBoundingBox(), var5 + 0.5)
                            && MinecraftClient.getInstance()
                                    ...
                                    == Type.MISS) {
                        Box var15 =
                                MinecraftClient.getInstance().player.dimensions.getBoxAt(var18);
    ...
    protected void d(Vec3d predictor) {
        if (this.t.uS) {
            if (predictor.y > MinecraftClient.getInstance().player.getY()) {
                this.u = predictor
                        .withAxis(Axis.Y, predictor.getY() + this.t.maceHeightGround.get())
                ...
                if (var3 < var5 && var2.y > var3) {
                    ...
                    Vec3d var7 = var2.withAxis(Axis.Y, 0.0)
                            .normalize()
                            .multiply(var5)
                            .withAxis(Axis.Y, var5);
            ...
            if (var9) {
                ...
                Vec3d var10 = null;
                boolean var11 =
                        predictor.getY() >= MinecraftClient.getInstance().player.getY();
                    ...
                    if (var11) {
                        ...
                        if (Math.abs(this.t.combatSmoothFlightArgument11.get()) > 1.0E-6
                                && (this.t.combatSmoothFlightArgument15.get()
                                                ? var14.subtract(MinecraftClient.getInstance()
                                                                .player
                                                                .getEyePos())
                                                        .horizontalLengthSquared()
                                                : var14.squaredDistanceTo(MinecraftClient.getInstance()
                                                        .player
                                                        .getEyePos()))
                                        < MathUtils.a(this.t.combatSmoothFlightArgument16.get())) {
                            var20 = var20.normalize();
                            Vec3d var21 = MinecraftClient.getInstance()
                                    .player
                                    .getEyePos()
                                    .subtract(var14);
                            Vec3d var22 = new Vec3d(var21.x, 0.0, var21.z)
                                    .normalize()
    ...
    public int onStatePullUp(StateMachine machine) {
        ...
        Vec3d var4 = MovTasks.simulateMovement(
                MinecraftClient.getInstance().player,
                MinecraftClient.getInstance().player.getPos(),
                var3,
                true);
        ...
        if (var9) {
            ...
            Vec3d var10 = this.t.macePullUpUsePredictor.get()
                    ? PositionPredict.INSTANCE.attackPredictArgument.get().predict(this.t.uI)
                    : this.t.uI.getPos();
            this.d(var10);
            machine.e();
