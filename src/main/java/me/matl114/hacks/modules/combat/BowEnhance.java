...
public class BowEnhance extends BaseModule {
   ...
   public void bowActionDelayMovement(Event<PlayerActionC2SPacket> event, @Nullable Entity entity, float initialVelocity) {
      if (this.canTp()) {
      ...
      if (entity != null) {
         ...
         ClientPlayerAccess.of(mc.player).getLegalMovementManager().i(new CombatSubHelperAX(this, entity, initialVelocity, var4));
      }
   }

   public BowEnhance() {
      super("BowEnhance");
      this.bowEnhanceHotkey = this.toggleHotkey(this.CZ.add("bow-enhance-hotkey"), new MultiKeyBind(), this.CZ.add("bow-enhance")).build();
      ...
      this.targetingMode = this.builder(this.CZ.add("targeting-mode"), Configs$LegalInteractMode.class)
         ...
         .build();
      this.tpAccelerate = this.builder(this.CZ.add("tp-accelerate"), DoubleRef.TYPE).defaultValue(150.0).show(this.tpEnable::get).build();
      this.tpAccelerateExactTp = this.flagBuilder(this.CZ.add("tp-accelerate-exact-tp")).show(this.tpEnable::get).build();
      this.versionLowerThan121 = this.flagBuilder(this.CZ.add("version-lower-than-121")).build();
   ...
   public void onRenderAimTarget(Event<MatrixStack> stackE) {
      ...
      if (this.ae.get() && this.aimEnable.get() && this.renderTarget.get() && mc.player != null && mc.player.isUsingItem()) {
         float var3 = (Float)stackE.c[0];
         ItemStack var4 = mc.player.getActiveItem();
         if (!var4.isEmpty() && (var4.getItem() instanceof RangedWeaponItem || var4.getItem() instanceof TridentItem)) {
   ...
   public void bowActionMovement(Event<PlayerActionC2SPacket> event, @Nullable Entity entity, float initialVelocity) {
      ...
      Vec3d var5 = entity == null
         ...
         : CombatTasks.m().predictAimPositionForEntity(entity, 3600000.0F).subtract(mc.player.getEyePos());
      Entity var6 = mc.crosshairTarget != null && mc.crosshairTarget.getType() == Type.ENTITY ? ((EntityHitResult)mc.crosshairTarget).getEntity() : null;
      ...
      if (this.canTp()) {
         ...
         boolean var16 = true;
         KalamaHelperHelperFX var17 = new KalamaHelperHelperFX(mc.player, var15, var15.add(var13.multiply(var10 + 1.0)), true);
         double var18 = var10;
            ...
            if (!(var18 > 10.0)) {
               ...
               while (true) {
                  ...
                  if (MovTasks.validMovementAsServer(var21, var22)) {
                     Vec3d var23 = var17.simulateMovement(mc.player, var15.add(var22), new Vec3d(0.0, var31.y, 0.0));
         ...
         if (var14.lengthSquared() > 1.0E-4) {
            ...
            if (!var27.isEmpty()) {
               Vec2f var32 = null;
               Debug.b(Text.literal("[Bow TP] Projectile Velocity Simulate %.2f".formatted(var14.length())).formatted(Formatting.GREEN));
               ArrayList var33 = new ArrayList();
               int var34 = var27.size();

               for (int var35 = 0; var35 < var34; var35++) {
                  var33.add(var35 == 0 ? MovTasks$MovInfo.adA((Vec3d)var27.get(var35)) : MovTasks$MovInfo.adz((Vec3d)var27.get(var35)));
               }
               ...
               var33.add(var16 ? new MovTasks$MovInfo(var15.add(0.0, 9.0E-8, 0.0), null, true, var32) : MovTasks$MovInfo.adz(var15.add(0.0, 9.0E-8, 0.0)));
      ...
      if (var7 && entity != null && entity != var6) {
         ...
         if (!Float.isNaN(var28.x) && !Float.isInfinite(var28.x) && !Float.isNaN(var28.y) && !Float.isInfinite(var28.y)) {
            ...
            if (var2.getAction() == Action.RELEASE_USE_ITEM && mc.player != null) {
               ...
               if (var3.getItem() instanceof BowItem || var3.getItem() instanceof TridentItem) {
                  ...
                  if (var4) {
                     ...
                     if (var5 != null) {
                        Debug.b(
                           Text.literal("[Bow Aim] Aim at %s".formatted(var5 instanceof PlayerEntity var6 ? "player " : "entity "))
   ...
   public void bowActionInteractItem(Event<PlayerActionC2SPacket> event, @Nullable Entity entity, float initialVelocity) {
      Vec2f var4 = new Vec2f(mc.player.getPitch(), mc.player.getYaw());
      Vec3d var5 = entity == null
         ? mc.player.getRotationVector().normalize()
         : CombatTasks.m().predictAimPositionForEntity(entity, 3600000.0F).subtract(mc.player.getEyePos());
         ...
         while (true) {
            if (!(var18 > 10.0)) {
               ...
               while (true) {
                  ...
                  Vec3d var22 = var17.simulateMovement(mc.player, var15, var21);
                  if (MovTasks.validMovementAsServer(var21, var22)) {
                     Vec3d var23 = var17.simulateMovement(mc.player, var15.add(var22), new Vec3d(0.0, var30.y, 0.0));
                     Vec3d var24 = var22.add(var23);
                     if (MovTasks.validMoveTo(var17, var15.add(var24), var24.multiply(-1.0))) {
                        var14 = var24;
                        break label98;
         ...
         if (var14.lengthSquared() > 1.0E-4) {
            ...
            if (!var27.isEmpty()) {
               ...
               for (int var33 = 0; var33 < var32; var33++) {
                  var31.add(var33 == 0 ? MovTasks$MovInfo.adA((Vec3d)var27.get(var33)) : MovTasks$MovInfo.adz((Vec3d)var27.get(var33)));
               }
      ...
      if (var7 && entity != null && entity != var6) {
         ...
         if (!Float.isNaN(var28.x) && !Float.isInfinite(var28.x) && !Float.isNaN(var28.y) && !Float.isInfinite(var28.y)) {
            mc.interactionManager.sendSequencedPacket(mc.world, s -> new PlayerInteractItemC2SPacket(mc.player.getActiveHand(), s, var28.y, var28.x));
         } else {
            Debug.b("[Bow Aim] Arrow failed to reach the target");
         }
      }
