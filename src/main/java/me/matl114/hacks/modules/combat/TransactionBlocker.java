...
public class TransactionBlocker extends BaseModule {
    ...
    public TransactionBlocker() {
        ...
        this.J = this.toggleHotkey(this.pe.addHotkey(), new MultiKeyBind(), this.pe.addEnable())
                .build();
    ...
    public void xu() {
        PacketManager.n(packet ->
                this.isTransactionRelated(packet.packetType()) ? KalamaHelperHelperG.NT : KalamaHelperHelperG.NV);
    }
