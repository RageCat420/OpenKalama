...
public record InvSubHelperL(InvSubHelperS type, int from, int to, boolean dump) {
    ...
    static final MapCodec<InvSubHelperL> wJ = RecordCodecBuilder.mapCodec(oinstance -> oinstance
            .group(
                    CodecUtils.enumCodec(InvSubHelperS.class)
                            .optionalFieldOf("type", InvSubHelperS.Iv)
                            .forGetter(InvSubHelperL::Ir),
