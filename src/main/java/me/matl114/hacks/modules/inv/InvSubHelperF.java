...
public record InvSubHelperF(int index, List<InvSubHelperB> kitList) {
    public static Codec<InvSubHelperF> CODEC = RecordCodecBuilder.create(oinstance -> oinstance
            .group(
                    Codec.INT.fieldOf("index").forGetter(InvSubHelperF::vC),
                    Codec.list(InvSubHelperB.dt).fieldOf("kit-map").forGetter(InvSubHelperF::vD))
