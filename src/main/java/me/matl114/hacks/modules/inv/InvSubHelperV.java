...
public class InvSubHelperV {
   ...
   HandledScreen<?> f;
   Optional<Block> h;
   public static final Codec<InvSubHelperV> CODEC = RecordCodecBuilder.create(
   ...
   public InvSubHelperV(
      List<KalamaHelperHelperK<ItemStack>> slots, int size, Optional<Text> title, Optional<Block> chestType, Optional<ContainerPosition> containerPosition
   ) {
