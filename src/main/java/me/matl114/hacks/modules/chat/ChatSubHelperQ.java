...
public class ChatSubHelperQ implements EncryptChat$Encryptor {
    ...
    public String encrypt(String message) {
        try {
            if (this.c.initialVector) {
                ...
                return EncryptUtils.i(ByteBuffer.allocate(var3.length + ((byte[]) var2.getSecond()).length)
                        .put((byte[]) var2.getSecond())
                        .put(var3)
                        .array());
            } else {
                ...
                | IllegalBlockSizeException var4) {
    ...
    public ChatSubHelperQ(SecretKey key, EncryptChat$AESEncryption algorithm) {
        ...
        try {
            ...
            if (this.c.initialVector) {
                var3.init(1, this.b, (AlgorithmParameterSpec)
                        (Object) this.generateIV().getFirst());
            } else {
                var3.init(1, this.b);
            }
            ...
            if (this.c.initialVector) {
                var4.init(2, this.b, (AlgorithmParameterSpec)
                        (Object) this.generateIV().getFirst());
            } else {
                var4.init(2, this.b);
            }
