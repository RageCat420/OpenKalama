...
public class ChatTools extends BaseModule {
    ...
    private String Ht;
    private static final List<Text> Hq =
    ...
    private void initToolWidget() {
        ...
        ContentDelegateWidget var4 =
                McWidgetHelpers.c(0, 48, 120, 20, PropertyTracker.event(this.cached::set), this.cached.get());
        this.Hx = (TextFieldWidget) var4.ef();
        ExecutableWidget.instance(120, 48, 60, 20)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.literal("send cache")),
                                ButtonAction.a(() -> ChatTasks.sayMessage(this.cached.get(), true)))
        ...
        ExecutableWidget.instance(180, 48, 50, 20)
                .<ExecutableWidget>eV(new ButtonElement(TextProvider.c(Text.literal("auto-send")), ButtonAction.a(var5))
                        .cw(el -> this.Hc.get())
                        .aO(TooltipHandler.ap(Hm)))
                .addToSub(var3);
        Runnable var6 = HotKeyUtils.h(Configs.h, this.ew.add("keep-chat-inv").toPath());
        ExecutableWidget.instance(180, 24, 70, 20)
                .<ExecutableWidget>eV(
                        new ButtonElement(TextProvider.c(Text.literal("keep-chat-inv")), ButtonAction.a(var6))
                                .cw(el -> this.Hf.get())
                                .aO(TooltipHandler.ap(Hn)))
                .addToSub(var3);
        ExecutableWidget.instance(120, 24, 60, 20)
                .<ExecutableWidget>eV(
                        new ButtonElement(TextProvider.c(Text.literal("to-unicode")), ButtonAction.a(() -> {
                                    TextFieldWidget var1x = this.findCurrentFocusing();
                                    if (var1x != null) {
                                        var1x.setText(ChatUtils.d(var1x.getText()));
                                    }
                                }))
                                .aO(TooltipHandler.ap(Ho)))
                .addToSub(var3);
        ExecutableWidget.instance(0, 24, 20, 20)
                .<ExecutableWidget>eV(IconElement.co(
                                Hi,
                                Hj,
                                ButtonAction.b(i -> {
                                    if (i) {
                                ...
                                el -> ChatTasks.k().shouldEncryptSendMessage())
                        .aO(TooltipHandler.ap(Hq)))
                .addToSub(var3);
        ExecutableWidget.instance(20, 24, 20, 20)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.literal("F").formatted(Formatting.BOLD)), ButtonAction.b(i -> {
                                    if (i) {
                        ...
                        .cw(el -> ChatTasks.f().enableChatMessageFormat.get())
                        .aO(TooltipHandler.ap(Hr)))
                .addToSub(var3);
        ContentDelegateWidget var7 =
                McWidgetHelpers.c(40, 24, 40, 20, PropertyTracker.event(s -> this.Ht = s), this.Ht);
        this.Hy = (TextFieldWidget) var7.ef();
        ExecutableWidget.instance(80, 24, 40, 20)
                .<ExecutableWidget>eV(new ButtonElement(
                                TextProvider.c(Text.literal("int<->char")),
                                ButtonAction.a(() -> this.tranlateInt2char(this.Hy)))
                        .aO(TooltipHandler.ap(Hp)))
                .addToSub(var3);
        ContentDelegateWidget var8 = new ContentDelegateWidget(250, 0, 0, 0).addToSub(var3);
        ExecutableWidget.instance(225, 0, 22, 20)
                .<ExecutableWidget>eV(new ButtonElement(
                                el -> this.enableQuickChars.get() ? Hz : HA,
                                ButtonAction.a(this.enableQuickChars::toggle))
                        .aO(TooltipHandler.ap(Hs)))
                .addToSub(var3);
        this.Hw = var8;
        this.Hu = var3;
    ...
    public void onRemoveCommandPrefix() {
        if (mc.currentScreen instanceof ChatScreen var2
                && var2.getFocused() instanceof TextFieldWidget var4
                && var4.getText().startsWith("/")) {
    ...
    public void onChatScreenInitialize(Event<ChatScreen> event) {
        ...
        ExecutableWidget.instance(var2.width - 20, var2.height - 56, 20, 20)
                .<ExecutableWidget>eV(new ButtonElement(
                                el -> this.enableTools.get() ? Hz : HA, ButtonAction.a(this.enableTools::toggle))
                        .aO(TooltipHandler.ap(Hk)))
                .addTo(var2);
    ...
    public ChatTools() {
        super("ChatTools");
        this.enableTools = this.flagBuilder(this.ew.add("enable-tools"))
                .updateListener(this::toggleBasicToolScreen)
                .build();
        this.enableQuickChars = this.flagBuilder(this.ew.add("enable-quick-chars"))
        ...
        this.quickChars = this.builder(this.ew.add("quick-chars"), String.class)
                ...
                .build();
        this.cached = this.builder(this.ew.add("cached"), String.class)
                .defaultValue("")
                .build();
        this.Hc = this.flagBuilder(Configs.h, this.ew.add("auto-chat").toPath()).build();
        this.autoChatPeriod = this.intBuilder(this.ew.add("auto-chat-period"))
                .defaultValue(21)
                .build();
        this.autoChatMultiple = this.intBuilder(this.ew.add("auto-chat-multiple"))
                .defaultValue(1)
                .build();
        this.Hf = this.flagBuilder(Configs.h, this.ew.add("keep-chat-inv").toPath())
                .build();
        this.obfLoginMessage =
                this.flagBuilder(this.ew.add("obf-login-message")).build();
        this.Hh = this.hotkey(
                        Configs.h, this.ew.add("remove-command-prefix-hotkey").toPath(), new MultiKeyBind())
    ...
    public void fixIMBlockerStateError(Event<ChatScreen> event) {
        if (IMBlockerHooks.getInstance().isEnabled()
                && ((ChatScreen) event.b).getFocused() instanceof FocusableObject var3) {
            ...
            if (bl) {
                ...
                for (int var9 = 0; var9 < var3; var9++) {
                    ...
                    ExecutableWidget.instance(100 - 25 * var5, (var4 - var7) * 24, 22, 20)
                            .<ExecutableWidget>eV(
                                    new ButtonElement(TextProvider.c(Text.literal(var13)), ButtonAction.a(() -> {
