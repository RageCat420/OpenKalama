...
public final class ChatSubHelperH {
   ...
   private String e;
   public static final Codec<ChatSubHelperH> b = RecordCodecBuilder.create(
      instance -> instance.group(
            Codec.STRING.fieldOf("name").forGetter(ChatSubHelperH::c),
            CodecUtils.enumCodec(EncryptChat$EncryptAlgorithm.class).fieldOf("algorithm").forGetter(ChatSubHelperH::e),
