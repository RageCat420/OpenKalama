...
public record ChatSubHelperK(int selected, List<ChatSubHelperH> entries) {
    public static final Codec<ChatSubHelperK> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                    Codec.INT.fieldOf("selected").forGetter(ChatSubHelperK::selected),
                    Codec.list(ChatSubHelperH.b).fieldOf("entries").forGetter(ChatSubHelperK::entries))
