...
public record KalamaHelperHelperC(
        Identifier identifier, Recipe<?> instance, RecipeType<?> type, ItemStack output, RecipeIngredient[] ingredients)
