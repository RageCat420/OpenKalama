...
public class BaseModule implements IModule {
    ...
    protected static StringFormat moduleMessageFormat =
    ...
    public WrapperSettingBuilder<MultiKeyBind> toggleConfigHotkey(
        ...
        return this.builder(config, MultiKeyBind.class)
                .path(path)
                .defaultValue(defaultValue)
                .registerHotkey(HotKeyUtils.i(Configs.s, path));
    }
    ...
    public WrapperSettingBuilder<MultiKeyBind> moduleEntry(
        ...
        return this.moduleEntry(
                hotkeyPath.getConfig(), hotkeyPath.toPath(), defaultValue, togglePath.toPath(), descriptor);
    }
    ...
    public DrawableWidget createExecuteButton(
        ...
        return ExecutableWidget.instance(x, y, dx, dy)
                .eV(new ButtonElement(TextProvider.c(Text.translatable(translationKey)), action)
                        .aO(TooltipHandler.ap(ChatUtils.parseTranslation(translationKey + ".tooltips", ""))));
    }
    ...
    private void ensureInstanceSet() {
        try {
            ...
            if (Modifier.isStatic(var1.getModifiers())
                    && !Modifier.isFinal(var1.getModifiers())
                    && var1.getType() == this.getClass()) {
    ...
    public WrapperSettingBuilder<MultiKeyBind> moduleEntry(
        ...
        return new WrapperModuleSettingBuilder(
                        ...
                        config,
                        this,
                        new KalamaHelperHelperI(config, togglePath, hotkeyPath, descriptor))
                .defaultValue(defaultValue)
                .registerHotkey(HotKeyUtils.i(config, togglePath))
                .registerModuleEntry();
    }
    ...
    public static Text getModuleMeta(Enum<?> enumReff) {
        ...
        return Text.translatable("module-meta." + var1.getConfigEnumType().replace("_", "-") + "."
