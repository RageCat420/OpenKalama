...
public class ItemCache {
      ...
      try {
         ...
         try {
            if (!this.b) {
               ...
               this.f = new LinkedHashMap<>((Map<? extends String, ? extends ItemStackData>)((Pair)k.decode(JsonOps.INSTANCE, var4).getOrThrow()).getFirst());
               this.d = false;
               this.g = new HashMap<>();
   ...
   public void save() {
      ...
      try {
         ...
         if (this.d) {
            this.d = false;
            JsonElement var1 = (JsonElement)k.encodeStart(JsonOps.INSTANCE, this.f).getOrThrow();
   ...
   public Pair<String, ItemStackData> n(ItemStackData stackData) {
      ...
      if (var2 == null) {
         return this.m((ItemStackData)(stackData instanceof KalamaHelperHelperD var3 ? var3 : ItemStackData.wrapCopy(stackData.ge())));
      } else {
