...
public class BlockStorage extends IStorage {
   public Block h;
   public static final Codec<BlockStorage> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            Identifier.CODEC.xmap(Registries.BLOCK::get, Registries.BLOCK::getId).fieldOf("type").forGetter(BlockStorage::u),
