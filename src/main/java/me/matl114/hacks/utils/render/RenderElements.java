         ...
         if (var3) {
            ...
            return var4
               ...
               : List.of(
                  ...
                  new HackUtilHelperD(new Vec3d(var2.x, var2.y, var1.z), new Vec3d(var1.x, var2.y, var1.z)),
                  new HackUtilHelperD(new Vec3d(var1.x, var2.y, var1.z), new Vec3d(var1.x, var1.y, var1.z))
               );
         }
      } else {
         return List.of(
   ...
   public static List<HackUtilHelperL> boxFaces(Box box) {
      ...
      if (var6 >= 2) {
         ...
         if (var3) {
            ...
            return var4 ? List.of(new HackUtilHelperL(box, Direction.DOWN)) : List.of(new HackUtilHelperL(box, Direction.NORTH));
         }
      } else {
         return List.of(
