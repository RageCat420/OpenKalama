            ...
            for (KalamaHelperHelperK var6 : this.entries) {
                ...
                if (var10 != null) {
                    ...
                    try {
                        ...
                        double var14 = RenderCollectors.mc
                                .textRenderer
                                .getTextHandler()
                                .getWidth(var12);
                        int var16 = var13 % 3;
                        int var17 = var13 / 3;
                        vdraw.f().translate((float) (-(var14 * var16 / 2.0)), (float)
                                (-(RenderCollectors.HEIGHT * var17 / 2.0)));
                ...
                for (Text var13 : var10) {
                    VRender.getInstance()
                            .drawTextCameraCoord(
                                    var13.asOrderedText(),
                                    stack,
                                    Vec3d.ZERO.add(0.0, -var11 * 9.0, 0.0),
                                    ((HackUtilHelperB) var4.val()).offSetFlag(),
                                    new Color(var5),
                                    VRender.a);
                    var11++;
                }
