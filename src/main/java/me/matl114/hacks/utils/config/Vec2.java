    ...
    public static final NBTType<Vec2> TYPE = new NBTType<>(
            ...
            (s, x, y, dx, dy) -> {
                ...
                return subScreenWidget
                        .Q(new TypeConvertAttrKeyValue<>(s, PAIR_FACTORY.asFirstWrapper(s::getOriginValue), NBTTypes.e)
                                .generateValueWidget(0, 0, half, dy))
                        .Q(new TypeConvertAttrKeyValue<>(s, PAIR_FACTORY.asSecondWrapper(s::getOriginValue), NBTTypes.e)
