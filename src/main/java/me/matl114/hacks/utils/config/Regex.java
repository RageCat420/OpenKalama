...
public class Regex implements NBTParsable<Regex>, Predicate<String> {
    ...
    public static final NBTType<Regex> TYPE =
            NBTTypes.e("regex", NBTTypes.g, WrapperFactory.of(Regex::new, Regex::regex));
    ...
    static {
        ...
        AttrKeyValue.CustomWidgetFactory<Regex> newWidget = (s, x, y, dx, dy) -> {
            ...
            subScreenWidget.Q(ExecutableWidget.instance(dx - dy, 0, dy, dy)
                    .eV(IconElement.cm(KalamaHelperHelperB.d, ButtonAction.a(Regex::runHelpRegex))
                            .aO(TooltipHandler.ap(
                                    ChatUtils.parseTranslation("widget.nbt-parsable.regex.rules.tooltips", "")))));
