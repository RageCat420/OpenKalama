...
public record WrapColor(TextColor color) implements NBTParsable<WrapColor> {
   ...
   public static NBTType<WrapColor> TYPE = NBTTypes.createXMap("wrapcolor", NBTTypes.h, WrapperFactory.of(WrapColor::new, WrapColor::color));
   ...
   public <W> Optional<WrapColor> tryTypeConvert(Ref<W> ref) {
      return ref instanceof IntRef intRef ? Optional.of(new WrapColor(TextColor.fromRgb(intRef.get()))) : Optional.empty();
   }
}
