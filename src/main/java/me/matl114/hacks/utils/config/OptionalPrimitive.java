...
public class OptionalPrimitive<T> implements NBTParsable<OptionalPrimitive<T>> {
    ...
    public static final Class<OptionalPrimitive<Double>> DOUBLE_TYPE =
            (Class<OptionalPrimitive<Double>>) (Class<?>) OptionalPrimitive.class;

    public static final Class<OptionalPrimitive<Integer>> INT_TYPE =
            (Class<OptionalPrimitive<Integer>>) (Class<?>) OptionalPrimitive.class;
    boolean present;
    NBTType<T> type;
    T value;
    public static final NBTType<OptionalPrimitive> TYPE = new NBTType<>(
            ...
            (s, x, y, dx, dy) -> {
                ...
                subScreenWidget.Q(
                        new TypeConvertAttrKeyValue<>(s, factory.asFirstWrapper(s::getOriginValue), NBTTypes.f)
                ...
                KalamaHelperHelperJ<?> widget2 = new KalamaHelperHelperJ<>(
                        () -> ((OptionalPrimitive) s.getOriginValue()).isPresent() ? widget : null, 0, 0);
    ...
    public boolean equals(Object obj) {
        return obj instanceof OptionalPrimitive<?> pmt
                && pmt.type == this.type
                && pmt.present == this.present
                && Objects.equals(pmt.value, this.value);
    }
