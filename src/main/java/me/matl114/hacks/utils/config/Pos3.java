    ...
    public static final NBTType<Pos3> TYPE = new NBTType<>(
            ...
            (s, x, y, dx, dy) -> {
                ...
                WrapperFactory<Integer, Pos3> firstWrapper =
                        WrapperFactory.of(d -> ((Pos3) s.getOriginValue()).withX(d), Pos3::x);
                WrapperFactory<Integer, Pos3> secondWrapper =
                        WrapperFactory.of(d -> ((Pos3) s.getOriginValue()).withY(d), Pos3::y);
                WrapperFactory<Integer, Pos3> thirdWrapper =
                        WrapperFactory.of(d -> ((Pos3) s.getOriginValue()).withZ(d), Pos3::z);
                return subScreenWidget
                        .Q(new TypeConvertAttrKeyValue<>(s, firstWrapper, NBTTypes.c)
                        ...
                        .Q(new TypeConvertAttrKeyValue<>(s, thirdWrapper, NBTTypes.c)
                                .generateValueWidget(2 * half, 0, half, dy))
                        .Q(ExecutableWidget.instance(3 * half, 0, half / 2, dy)
                        ...
                        .Q(ExecutableWidget.instance(4 * half - half / 2, 0, half / 2, dy)
                                .eV(new ButtonElement(
                                                TextProvider.c(Text.translatableWithFallback(
