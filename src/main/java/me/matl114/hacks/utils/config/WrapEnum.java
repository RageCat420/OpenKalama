...
public class WrapEnum<T extends ConfigEnum> implements NBTParsable<WrapEnum<T>> {
    ...
    public static DataResult<WrapEnum<?>> fromString(String str) {
        ...
        return re.type != null && re.valueString != null
                ? DataResult.success(re)
                : DataResult.error(() -> "Can not parse ConfigEnum type: " + str);
    }
            ...
            if (re == null) {
                ...
                Preconditions.checkNotNull(
                        ...
                        "Unregistered enum value %s in enum type %s with %s"
                                .formatted(this.valueString, this.type, re.toString()));
                this.resolved = true;
                this.value = (T) val;
            }
        }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            return !(obj instanceof WrapEnum wrap)
                    ? false
                    : Objects.equals(wrap.type, this.type) && Objects.equals(wrap.valueString, this.valueString);
        }
    }
