...
public class KalamaHelperHelperNX extends AbstractMainCommand {
    ...
    public void onResource(ArgumentInputStream re) {
        ...
        switch (var2) {
            case "world":
                List var11 = ChatTasks.j.getNetworkHandler().getWorldKeys().stream()
                        .<Identifier>map(RegistryKey::getValue)
                        .filter(u -> var4 == null
                                || u.getPath().contains(var4.getPath())
                                        && (!var5 || u.getNamespace().contains(var4.getNamespace())))
                        .toList();
                this.onResource0(var2, var11);
                break;
            case "command":
                List var10 = ChatTasks.j.getNetworkHandler().getCommandDispatcher().getRoot().getChildren().stream()
            ...
            case "seed":
                List var9 = List.of(
                        Text.literal("服务端加密种子: ")
                                .append(ChatUtils.getDisplayedLong(ChatTasks.j.world.getBiomeAccess().seed)),
                        Text.literal("当前绑定种子: ").append((Text)
            ...
            case "plugins":
                ...
                List var6 = ClientUtils.getServerCommands().stream()
                        .map(n -> {
                            String[] var1 = n.split(":");
                ...
                ClientUtils.c()
                        .thenAccept(list -> this.onResource0(
                                var2,
                                list.stream()
    ...
    public void onListRegistry(ArgumentInputStream re) {
        ...
        if (var4 != null) {
            ...
            for (Object var9 : var4.getKeys()) {
                ...
                if (var6 == null
                        || var11.contains(var6.getPath())
                                && (!var7 || var10.getNamespace().contains(var6.getNamespace()))) {
                    Debug.b(var10);
                }
            }
        } else {
    ...
    public void onInfo(ArgumentInputStream re) {
        ...
        String var3 = re.n();
        PlayerEntity var4 =
                Objects.equals("#me", var3) ? (PlayerEntity) ChatTasks.j.player : EntityUtils.getPlayerByName(var3);
        if (var4 != null) {
        ...
        switch (var2) {
                ...
                if (var4 != null) {
                    ...
                    if (var20.isPresent()) {
                        ...
                        Debug.chat(
                                ...
                                var28.getValue(),
                                ",Pos:",
                                ChatUtils.getDisplayedLocation(Vec3d.of(var25.pos())),
                                "]");
                    } else {
            ...
            case "spawn":
                ...
                Debug.chat(
                        ...
                        var24.getValue(),
                        ",Pos:",
                        ChatUtils.getDisplayedLocation(Vec3d.of(var19)),
                        "]");
                break;
            case "nbt":
                if (var4 != null) {
                ...
                if (var4 != null) {
                    ...
                    Tasks.l(
                            () -> ScreenAccess.of(new InventoryViewScreen(
                                            var17,
                                            Text.literal("背包预览 - " + var4.getNameForScoreboard()),
            ...
            case "trackinventory":
                if (var4 != null) {
                    ...
                    Tasks.l(
                            () -> ScreenAccess.of(new InventoryViewScreen(
                                            InventoryUtils.d(var23),
                                            Text.literal("背包追踪预览 - " + var4.getNameForScoreboard()),
            ...
            case "ender":
                if (var4 != null) {
                    net.minecraft.inventory.Inventory var15 =
                            var4 == ChatTasks.j.player ? ChestHistory.INSTANCE.PY() : var4.getEnderChestInventory();
                    Tasks.l(
                            () -> ScreenAccess.of(new InventoryViewScreen(
                                            var15,
                                            Text.literal("末影箱预览 - " + var4.getNameForScoreboard()),
            ...
            case "plist":
                ...
                ChatTasks.j.getNetworkHandler().getPlayerList().stream()
                        ...
                        .map(entry -> {
                            MutableText var1 = Text.literal(
                                    ...
                                    .append(Text.literal(
                                            ", GameMode: " + entry.getGameMode().name() + ")"));
                            Debug.f(var1);
                            return var1;
                        })
                        .forEach(Debug::b);
            ...
            case "team":
                ...
                PlayerListEntry var22 =
                        MinecraftClient.getInstance().getNetworkHandler().getPlayerListEntry(var14);
                if (var22 != null) {
                    ...
                    if (var27 != null) {
                        ...
                        Debug.chat(
                                ...
                                var27.getDisplayName() == null ? "" : var27.getDisplayName());
                        Debug.chat(
                                Text.literal("前缀: ").formatted(Formatting.GRAY),
                                var27.getPrefix() == null ? "" : var27.getPrefix());
                        Debug.chat(
                                Text.literal("后缀: ").formatted(Formatting.GRAY),
                                var27.getSuffix() == null ? "" : var27.getSuffix());
                        Debug.chat(
                                Text.literal("颜色: ").formatted(Formatting.GRAY),
                                var27.getColor() == null ? "" : var27.getColor());
                        ...
                        Debug.chat(
                                ...
                                var27.shouldShowFriendlyInvisibles());
            ...
            case "pentry":
                ...
                PlayerListEntry var21 =
                        MinecraftClient.getInstance().getNetworkHandler().getPlayerListEntry(var13);
                if (var21 != null) {
                    ...
                    Debug.chat(
                            ...
                            ChatUtils.y(VRecord.getId(var21.getProfile()).toString())
                                    .formatted(Formatting.GREEN));
                    Debug.chat(
                            Text.literal("Property: ").formatted(Formatting.GRAY),
                            ChatUtils.getHoverShowText(
                                    "[点击查看具体数据]",
                                    List.of(Text.literal(VRecord.getProperties(var21.getProfile())
                                            .toString()))));
                    Debug.chat(
                            Text.literal("GameMode: ").formatted(Formatting.GRAY),
                            var21.getGameMode().name());
                    Debug.chat(
                            Text.literal("DisplayName: ").formatted(Formatting.GRAY),
                            var21.getDisplayName() == null ? Text.literal("null") : var21.getDisplayName());
                    ...
                    Debug.chat(
                            ...
                            ChatUtils.getHoverShowText("[点击查看具体数据]", var26));
                } else {
            ...
            case "server":
                ...
                Debug.chat(
                        ChatUtils.y(var12).formatted(Formatting.GREEN),
                        "|",
                        ChatTasks.j.world.getRegistryKey().getValue());
                break;
            case "waypoint":
                Debug.b("查询中");
                ...
                if ((var7 = ChatTasks.j.getNetworkHandler().getPlayerListEntry(var3)) != null) {
                    ...
                    var8 = (Predicate<KalamaHelperHelperAk>)
                            s -> var9.equalsIgnoreCase((String) s.b().map(UUID::toString, Function.identity()));
                } else {
                ...
                WorldUtils.d()
                        ...
                        .forEach(s -> {
                            ...
                            Optional<PlayerListEntry> var1 = s.b().left().isPresent()
                                    ? Optional.ofNullable(ChatTasks.j
                                            .getNetworkHandler()
                                            .getPlayerListEntry(s.b().left().get()))
                                    : Optional.ofNullable(ChatTasks.j
                                            .getNetworkHandler()
                                            .getPlayerListEntry(s.b().right().get()));
                            var1.ifPresent(playerListEntry ->
                                    Debug.b("Potential Owner: " + VRecord.getName(playerListEntry.getProfile())));
                            Debug.b("config: ");
    ...
    public Stream<String> supplyModule() {
        return HackModules.getModuleGroups().stream()
                ...
                .flatMap(
                        b -> b.getModuleEntries().map(ModuleEntry::getToggleKey).map(ChatUtils::H));
    }
    ...
    public void A(ArgumentInputStream re) {
        ...
        Listener.bx()
                .b(new Event<>(
                        new me.matl114.events.impl.KalamaHelperHelperI<>(ModulePreset.class, var2), false, false));
    ...
    public KalamaHelperHelperNX() {
        this.g
                ...
                .A(me.matl114.utils.commands.params.KalamaHelperHelperA.a()
                        .B("what")
                        .m(List.of("command", "module", "all"), "command")
                        .v())
        ...
        this.g
                ...
                .A(me.matl114.utils.commands.params.KalamaHelperHelperA.a()
                        .B("filter")
                        .l("<namespace_filter>:<path_filter>")
                        .b("")
                        .v())
        ...
        this.g
                .subBuilder(SubCommand.bo())
                .u("say")
                .x("message.command.sfh.say.help")
                .z(e -> e.executor((a, b, c) -> {
        ...
        this.g
                .subBuilder(SubCommand.bo())
                .u("logout")
                .x("message.command.sfh.exit.help")
                .z(e -> e.executor(KalamaHelperHelperH.g(MainTasks::q)))
                .r();
        this.g
                .subBuilder(SubCommand.bo())
                .u("toggle")
