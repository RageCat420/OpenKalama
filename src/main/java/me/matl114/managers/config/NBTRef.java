...
public class NBTRef<T extends NBTParsable<?>> extends LazilyRegisterTypeRef<T, NbtElement> {
         ...
         if (re == null) {
            ...
            try {
               ...
               throw new RuntimeException(
                  "Raw NBT value could not be parsed into type "
                     + this.type.typeName
   ...
   protected T validateAndCast(Object val) {
      ...
      T configEnum = (T)val;
      Preconditions.checkArgument(Objects.equals(this.enumType, configEnum.type().typeName().toLowerCase(Locale.ROOT)), "Nbt type mismatch !");
      return configEnum;
   }
