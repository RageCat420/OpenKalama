...
public class Refs {
    private static final List<Refs.TypedReferenceBuilder<?>> referenceBuilders =
            ImmutableList.<Refs.TypedReferenceBuilder<?>>builder()
                    ...
                    .add(new Refs.TypedReferenceBuilder<>(
                            String.class,
