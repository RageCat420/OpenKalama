...
public class MultiKeyBind {
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            return !(obj instanceof MultiKeyBind var2)
                    ? false
                    : Arrays.equals(this.keyCodes, var2.keyCodes) && var2.c == this.c && var2.d == this.d;
        }
    }
    ...
    public boolean e() {
        return this.keyCodes.length == 0
                ? false
                : SimpleInputManager.h().isKeyPressed(this.keyCodes[this.keyCodes.length - 1]);
    }
