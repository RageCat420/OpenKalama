...
public class InputHelper {
   ...
   public static boolean o() {
      return SimpleInputManager.h().isKeyPressed(342) || SimpleInputManager.h().isKeyPressed(346);
   }
   ...
   public static boolean n() {
      return SimpleInputManager.h().isKeyPressed(341) || SimpleInputManager.h().isKeyPressed(345);
   }
      ...
      a.execute(() -> {
         ...
         if (var2 != null && a.getOverlay() == null) {
            if (Character.charCount(codePoint) == 1) {
               Screen.wrapScreenError(() -> var2.charTyped((char)codePoint, modifiers), "charTyped event handler", var2.getClass().getCanonicalName());
            } else {
               for (char var6 : Character.toChars(codePoint)) {
                  Screen.wrapScreenError(() -> var2.charTyped(var6, modifiers), "charTyped event handler", var2.getClass().getCanonicalName());
               }
            }
         }
      });
   ...
   public static boolean m() {
      return SimpleInputManager.h().isKeyPressed(340) || SimpleInputManager.h().isKeyPressed(344);
   }

   public static boolean p() {
      return SimpleInputManager.h().isKeyPressed(257) || SimpleInputManager.h().isKeyPressed(355);
   }
