...
public class ReflectHelper {
        ...
        if (t(b.getName())) {
            ...
            return u(b.getName())
                    ? a == null
                            ...
                            || b.isAssignableFrom(w(a.getClass().getName()))
    ...
    public static List<String> f(Object what) {
        Class var1 = what instanceof Class ? (Class) what : what.getClass();
        return Arrays.stream(var1.getEnumConstants())
                .map(s -> ((Enum) s).name())
                .toList();
    }
    ...
    private static boolean s(Class a, Class<?> b) {
        if (t(b.getName())) {
            ...
            return u(b.getName())
                    ? a == null || b.isAssignableFrom(a) || b.isAssignableFrom(w(a.getName()))
                    : a == null || b.isAssignableFrom(a);
        }
    }
    ...
    public static List<String> n(Object what) {
        Class var1 = what instanceof Class ? (Class) what : what.getClass();
        return Arrays.stream(var1.getDeclaredMethods())
    ...
    public static String o(Executable constructor) {
        ...
        var1.append(constructor.getAnnotatedReturnType().getType().getTypeName())
                .append(" ");
    ...
    public static List<String> i(Object what) {
        Class var1 = what instanceof Class ? (Class) what : what.getClass();
        return Arrays.stream(var1.getDeclaredConstructors())
                .map(ReflectHelper::o)
                .toList();
    }
    ...
    public static <T extends Enum<T>> T a(Class<T> enumClass, String name) {
        return (T) Arrays.stream((Enum[]) enumClass.getEnumConstants())
    ...
    private static String j(Type type) {
        if (type instanceof Class var1) {
            ...
            return type instanceof GenericArrayType var10
                    ? j(var10.getGenericComponentType()) + "[]"
                    : type.getTypeName();
        } else {
