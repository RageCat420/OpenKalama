...
public class KalamaHelperHelperG {
   ...
   private static void b() throws Exception {
      ...
      if (var0 == null) {
         ...
         Class<xyz.wagyourtail.jsmacros.core.library.BaseLibrary> var3 = xyz.wagyourtail.jsmacros.core.library.BaseLibrary.class;
   ...
   public static synchronized Class<?> f(Class<?> targetBaseClass, Class<?> libClass, Class<?> runerClass, Class<?> utilityClass) {
      try {
         boolean var4 = false;
         ...
         for (Method var18 : utilityClass.getDeclaredMethods()) {
            ...
            if (Modifier.isPublic(var19) && Modifier.isStatic(var19) && (var4 || var18.getAnnotation(Modifiable.class) != null)) {
               var28.add(var18);
               if (var18.getParameterCount() == 0 && var18.getReturnType() != void.class && var18.getName().startsWith("get")) {
         ...
         for (Field var36 : utilityClass.getDeclaredFields()) {
            ...
            if (Modifier.isPublic(var40) && Modifier.isStatic(var40) && (var4 || var36.getAnnotation(Modifiable.class) != null)) {
               ...
               if (!var29.contains(var46)) {
                  ...
                  var49.visitCode();
                  var49.visitFieldInsn(178, Type.getInternalName(var36.getDeclaringClass()), var36.getName(), ByteCodeUtils.a(var36.getType()));
         ...
         for (Field var47 : utilityClass.getDeclaredFields()) {
            ...
            if (Modifier.isPublic(var50) && Modifier.isStatic(var50) && var14.contains(var47)) {
               ...
               var35.visitVarInsn(25, 0);
               var35.visitFieldInsn(178, Type.getInternalName(var47.getDeclaringClass()), var47.getName(), ByteCodeUtils.a(var47.getType()));
