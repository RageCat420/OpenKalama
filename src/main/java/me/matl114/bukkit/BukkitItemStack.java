...
public sealed class BukkitItemStack implements Cloneable, Dispatch permits CraftItemStack {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof BukkitItemStack var2) ? false : this.getAmount() == var2.getAmount() && this.du(var2);
      }
   }
   ...
   public static BukkitItemStack deserialize(@NotNull Map<String, Object> args) {
      if (args.containsKey("schema_version")) {
         ...
         Item type;
         try {
            type = (Item)Registries.ITEM.get(new Identifier("minecraft", ((String)args.get("type")).toLowerCase(Locale.ROOT)));
