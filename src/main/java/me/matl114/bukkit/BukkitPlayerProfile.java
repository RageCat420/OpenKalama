...
public class BukkitPlayerProfile implements Dispatch {
   ...
   public static KalamaHelperHelperK fromBase64(UUID uuid, String base64skinTexture) {
      ...
      String var4 = var3.getAsJsonObject("textures").getAsJsonObject("SKIN").get("url").getAsString();
   ...
   public String toString() {
      return "{uid: " + this.lF + ",name: " + this.name + ",properties: " + (this.lH.isEmpty() ? "empty" : this.lH.toString()) + "}";
   }
