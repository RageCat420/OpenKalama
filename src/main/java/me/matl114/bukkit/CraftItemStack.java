...
public final class CraftItemStack extends BukkitItemStack {
    ...
    public static final Codec<ComponentChanges> CODEC_DISPLAY_CHANGES = Codec.of(
            ...
            Codec.unboundedMap(Codec.STRING, Codec.PASSTHROUGH).map(s -> {
                if (s.isEmpty()) {
                    ...
                    for (Entry var3 : s.entrySet()) {
                        ...
                        ComponentType var7 =
                                (ComponentType) Registries.DATA_COMPONENT_TYPE.get(Identifier.tryParse(var6));
                        if (var7 != null) {
                            if (var5) {
    ...
    private ItemStack buildDisplay0(Map<String, String> tag) {
        if (!Objects.equals(this.AI, "minecraft:air")) {
            try {
                ...
                ComponentChanges var11 = CODEC_DISPLAY_CHANGES
                        .decode(ItemStackUtils.registry().getOps(NbtOps.INSTANCE), var4)
                        .result()
