...
public class ConfigurationSerializableDataType<T extends Dispatch> {
    ...
    static String getExceptionMessage(Class<? extends Dispatch> type, KalamaHelperHelperI serializationType) {
    ...
    public T fromPrimitive(byte[] bytes) {
        try {
            Dispatch var4;
            try (ByteArrayInputStream var2 = new ByteArrayInputStream(bytes);
                    KalamaHelperHelperB var3 = new KalamaHelperHelperB(var2); ) {
                var4 = (Dispatch) var3.readObject();
            }

            return (T) var4;
        } catch (IOException var11) {
            throw new UncheckedIOException(getExceptionMessage(this.type, KalamaHelperHelperI.wA), var11);
        } catch (ClassNotFoundException var12) {
            throw new RuntimeException(getExceptionMessage(this.type, KalamaHelperHelperI.wA), var12);
        }
    }
    ...
    public byte[] toPrimitive(T serializable) {
        try {
            byte[] var4;
            try (ByteArrayOutputStream var2 = new ByteArrayOutputStream();
                    KalamaHelperHelperW var3 = new KalamaHelperHelperW(var2); ) {
                var3.writeObject(serializable);
                var4 = var2.toByteArray();
            }

            return var4;
        } catch (IOException var11) {
            throw new UncheckedIOException(getExceptionMessage(this.type, KalamaHelperHelperI.wz), var11);
        }
    }
}
