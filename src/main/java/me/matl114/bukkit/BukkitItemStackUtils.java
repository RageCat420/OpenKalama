...
public class BukkitItemStackUtils {
    ...
    public static ConfigurationSerializableDataType<BukkitItemStack> a =
        ...
        try {
            if (itemStack instanceof CraftItemStack var6) {
                ...
                if (itemStack.hasItemMeta()) {
                    ...
                    if (BukkitMetaType.lC.isType(var2)
                            && BukkitMetaType.lC.getAttr(var2, "skull-owner") instanceof BukkitPlayerProfile var4) {
    ...
    public static PropertyMap buildPropertyMap(PropertyMap oldMap, String hash) {
        try {
            Property var2 =
                    BukkitPlayerProfile.encodeUrlToProperty(BukkitPlayerProfile.tl(hash), KalamaHelperHelperM.yr, null);
