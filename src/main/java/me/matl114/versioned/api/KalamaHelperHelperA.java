...
public record KalamaHelperHelperA(boolean shadow, TextLayerType layerType, int backgroundColor, int light) {
    ...
    public KalamaHelperHelperA dI(int light) {
        return this.light == light
                ? this
                : new KalamaHelperHelperA(this.shadow, this.layerType, this.backgroundColor, light);
    }
    ...
    public KalamaHelperHelperA dH(int backgroundColor) {
        return this.backgroundColor == backgroundColor
                ? this
                : new KalamaHelperHelperA(this.shadow, this.layerType, backgroundColor, this.light);
    }
    ...
    public KalamaHelperHelperA withShadow(boolean shadow) {
        return this.shadow == shadow
                ? this
                : new KalamaHelperHelperA(shadow, this.layerType, this.backgroundColor, this.light);
    }
    ...
    public KalamaHelperHelperA withLayerType(TextLayerType layerType) {
        return this.layerType == layerType
                ? this
                : new KalamaHelperHelperA(this.shadow, layerType, this.backgroundColor, this.light);
    }
}
