...
public interface VRender {
    ...
    @KalamaHelperHelperB(b = "Lines", a = "PositionColorNormalLineWidth")
    ...
    default void v(
            Identifier path, net.minecraft.client.util.math.MatrixStack stack, Quad quad, UV uv, ColorQuad color) {
        this.m(path, (op, bf) -> op.drawTexturedQuad(stack, bf, quad, uv, color));
    }

    @KalamaHelperHelperB(b = "Rect", a = "PositionColor")
    void l(KalamaHelperHelperJ var1, boolean var2);

    void drawTextCameraCoord(
            OrderedText var1,
            net.minecraft.client.util.math.MatrixStack var2,
            Vec3d var3,
            int var4,
            Color var5,
            KalamaHelperHelperA var6);
    ...
    @KalamaHelperHelperB(b = "TexturedGui", a = "PositionTextureColor")
    ...
    @KalamaHelperHelperB(b = "Quad", a = "PositionColor")
    void j(KalamaHelperHelperJ var1, boolean var2);

    @KalamaHelperHelperB(b = "TexturedGui", a = "PositionTextureColor")
    void m(Identifier var1, KalamaHelperHelperJ var2);

    @KalamaHelperHelperB(b = "LineStrip", a = "PositionColorNormalLineWidth")
    ...
    @KalamaHelperHelperB(b = "Gui", a = "PositionColor")
    ...
    default void drawGuiSpriteQuadCameraCoord(
            Identifier path, net.minecraft.client.util.math.MatrixStack stack, Quad quad, UV uv, ColorQuad color) {
