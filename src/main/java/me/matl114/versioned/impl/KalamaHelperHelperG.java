...
public 
   ...
   public static KalamaHelperHelperG createContext(KalamaHelperHelperH kineticWeaponComponent, float f) {
      ...
      int var3 = kineticWeaponComponent.knockbackConditions().map(KalamaHelperHelperF::maxDurationTicks).orElse(0) + var2;
      int var4 = var3 - 20;
      int var5 = kineticWeaponComponent.dismountConditions().map(KalamaHelperHelperF::maxDurationTicks).orElse(0) + var2;
      int var6 = var5 - 40;
      int var7 = kineticWeaponComponent.dismountConditions().map(KalamaHelperHelperF::maxDurationTicks).orElse(0) + var2;
