...
public interface IMapDrawFactory {
    IMapDrawFeature ellipses(
            String var1,
            ElementSupplier<List<EllipseWrapper<?>>> var2,
            IntSupplier var3,
            Supplier<Float> var4,
            int var5);
    ...
    IMapDrawFeature lines(
            String var1, ElementSupplier<List<LineWrapper<?>>> var2, IntSupplier var3, Supplier<Float> var4, int var5);
